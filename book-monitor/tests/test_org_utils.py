...
class TestOrgUtils(unittest.TestCase):
    ...
    def test_count_words_plain_text(self):
        ...
        text = "This is a simple test with eight words."
...
More regular text here."""
        # Should count: This is regular text More regular text here (8 words)
        self.assertEqual(count_words(text), 8)
...
More text after properties."""
        # Should count: This is regular text More text after properties (8 words)
        self.assertEqual(count_words(text), 8)
...
More content here."""
        # Should count: Heading with tags This content should be counted Subheading More content here (14 words)
        self.assertEqual(count_words(text), 14)
...
More regular text."""
        # Should count: This is regular text More regular text (7 words)
