...
class TestChapter(unittest.TestCase):
    ...
    def test_chapter_calculate_word_count_with_sections(self):
        ...
        section1 = Section(title="Section 1", content="This has five words.")
        section2 = Section(title="Section 2", content="This section has four words.")
    ...
    def test_chapter_get_section_by_title(self):
        ...
        self.assertEqual(found_section.title, "Introduction")
