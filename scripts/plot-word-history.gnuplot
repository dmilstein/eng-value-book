...
words_today = system("grep 'today:' build/word-averages.txt | cut -d' ' -f2")
...
set label sprintf("Words today: %s", words_today) at graph 0.02, graph 1.00 font "monospace,12" tc rgb "black"
set label sprintf(" 7-day avg: %s words/day", avg_7day) at graph 0.02, graph 0.95 font "monospace,12" tc rgb "black"
set label sprintf("14-day avg: %s words/day", avg_14day) at graph 0.02, graph 0.90 font "monospace,12" tc rgb "black"
