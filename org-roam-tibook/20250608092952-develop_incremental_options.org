...
In fact, such a decision outcome hopefully prompt the engineers to ask:
...
E.g. say Andrea discovers that adding the SLI's is more work than expected. If she understands the decisions being made, she can shrink her scope to the 1-2 very most important ones and bring those to the meeting with the engineering leader and the stakeholder.

That will then the engineering leader to have *exactly* the conversation with the stakeholder that they promised: we have some initial visibility, we can now decide if it's sufficient or not, and what next steps we want to take.
