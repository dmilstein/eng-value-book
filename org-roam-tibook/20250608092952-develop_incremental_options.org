...
Your stakeholder isn't just asking for an estimate to be a jerk, they're asking because the new information you've shared, as part of your pitch for a tech investment, has *created new problems for them*.
...
By coming to the table with options for near-term tradeoffs, the engineering leader is, again, helping the stakeholder face a genuine challenge -- while still creating space for the stakeholder to disagree or even pushback ("we think", "if we understand it right", "we believe").
