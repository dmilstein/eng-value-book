...
Sometimes that's "positive" value: "It'll only take a few days to apply the new indexing scheme to the rest of our tables, and then the entire site should see better peformance".

Sometimes that's "negative", risk-avoidance value: "Our initial security review made clear that things are much worse than we realized -- we think it's more valuable for the company to pause work on the feature roadmap and get to a lower risk state, immediately."

But, of course, no one will think that way. Because of, well, a host of human cognitive biases, among other things.

So you have to gradually persuade people into working that way.
