...
Some examples:
 ...
 - The Sales Team might need to *learn how to sell* a new product or feature

   What is the most compelling way to position the value proposition, what supporting materials do they need, how can the create an effective demo.
product to customers.

 - For internal, or "operational" software (e.g. to run a warehouse, or to support a data ingestion team), migrate the operation from one system to another

   If you've never led such a migration, just assume it's a lot more involved and slow than you can even imagine.
