...
Obviously, engineers can't be expected to win, in the scenario above.

But, unfortunately, the stakeholders above have, well, genuinely reasonable concerns.
...
Why is the executive team demanding a commitment to a 9-month out launch date?

There's a simple, true, and unuseful answer, which is:

*"That is how projects are always run"*

As in, there's a good chance the executive team literally just thinks in terms of deadlines and commitments.

But why are projects run that way?

I can offer two very good reasons why executives ask for estimates of project length -- in other words, two important things they are *using* those estimate *for*.

 1) To decide which of several alternatives to invest in

    Imagine that, in attempting to grow revenue for next year, the executive team has narrowed in on two options: one is overhauling the patient onboarding process, the other is creating a new product offering for enterprise customers.

    The executive team is asking for an estimates of *effort* from the engineering team, because that's a way to both understand the *costs* of the two options, and also how long they'd have to wait to see a *return*. Depending on what they hear, they might choose option one or two.

    This is a genuine, crucial part of their role at the company -- and the engineering team absolutely needs to support them in making good decisions about overall investment opportunities.

    But, unfortunately, they can't provide reliable long-term estimates of effort.
...
And some *bad* reasons:
 ...
 - Trying to decide + how to coordinate efforts

 - Trying to understand + influence

 - Reacting to a surprise as a human

 - Making a determination of relative value
