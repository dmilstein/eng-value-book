...
I want to be carefully clear: these are engineers who love solving meaningful business problems.
...
# That doesn't necessarily mean that person gets to directly tell the engineers "what to do". But they are ultimately the ones who are determining if what the engineers did actually solved any business problems. It means they usually have some organizational authority to set overall priorities for the engineers. It also isn't always one person! What if the engineers work with multiple people who all have such authority? Or who all separately believe they have such authority?
...
It could even be *other engineers*, for eng teams who build developer platforms or tooling.[fn:: I *love* working on DevPlats, but I must also note that doing so means serving stakeholders who will question every single move you make. "You're unpacking the builds *on* the hosts? Why would you do that? That seems dumb."]
...
Because they want the overall business to succeed, the stakeholders on that list above all deeply believe that, when they make requests of the engineering team, they are being *completely and totally reasonable*.

And yet... *somehow*, engineers find themselves on the receiving end of a stream of requests they find anything *but* reasonable.

Let's walk through some typical challenges.
...
The Patient team has been somewhat hastily assembled, and it's not clear if Rich--the only experienced mobile engineer on the team--is going to be around after the next round of performance reviews.
...
That system is a terrifying pile of legacy code. It was written by a team of consultants a long time ago, has libraries that haven't been updated in years, and enjoys the test coverage of a pile of moldy tissue paper.
