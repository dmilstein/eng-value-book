...
*** Terrible Spike Which Will Illuminate Problems So I Can Fix Later
Now, all appearances to the contrary, I will assert that the engineering team and their stakeholders have the same underlying goal.

*They both want the business to succeed.*

They find themselves in conflict when, as is very common, they have different understandings of what to *do*, to help the business succeed.
...
This will help us identify key things each side is *trying* to do. And we can then find new ways to work, that achieve both side's goals.
