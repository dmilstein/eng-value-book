...
Your PM comes back from a meeting with the executive team, looks down at their notes, and then asks:
...
How are you supposed to answer this question?
 ...
 - *Guess and pad?*
   ...
   Talk to a few engineers, come up with a "reasonable" estimate, of say 4 months.

   Then, to be safe, you double that, see that it's less than 9 months, and say a cautious "Yes".

   Spoiler: this isn't gonna go much better.

 - *Cross your fingers and pray?*

   Just yolo it, and say /"Sure, let's go!"/
 ...
 - *Explain the details to your stakeholder?*
   ...
   You say, /"You see, the patient ~m_id's~ are the key thing we need, and we have to get those from the HL7 files, but they seem to be encoded in different ways..."/

   Spoiler: your stakeholder glazes over, and worst case, just repeats their demand/question.

This is in, some ways, the fundamental challenges in dealing with stakeholders.

We're going to talk in real detail about how to build a process of *shared decision-making*, so that you can partner with your stakeholder, to do what is best for your business... without having to commit to long-term delivery estimates.

# XXX HL7? L7? H7?

*** Constant Interruptions

Your team is hard at work building the new patient onboarding app... but every other day seems to feature the CEO popping into the team's Slack channel, fresh off a conversation with customers, asking for an engineer to dig into some new issue, or demanding an update on progress, or wanting to relitigate the carefully hammered-out prioritization scheme.

# Or wanting help with an enterprise sales convo, or wanting a "quick brainstorm" on level of effort [for some crazy speculative future thing unrelated to stated priorities]", or asking for an engineer to read some article about {AI, The Cloud, Crypto, <Insert new Buzzword>} so they can talk it out, I COULD GO ON ALL DAY.
...
But your CEO gets extremely salty when you suggest that they stay out of the team's hair.
...
Oh, and a fun alternate version of this: the CEO is actually well-behaved, *wants* the team to cleanly focus on the new product and is even doing a reasonable job of waiting for the upcoming demo... but the team is stil distracted, because they're fielding a chaotic swirl of bugs, feature requests, and mini-incidents from the teams that work "close to the customer", e.g. Sales, Support, Success.

And the CEO isn't willing to push back, because they "care about the customer".
...
For the rest, you'd need to back up and gather that info another way entirely -- the team has an idea of how to make it work, but it would mean both developing a relationship with a new data broker *and* overhauling a part of the ingest pipeline.

Or you could back up and fundamentally change the planned design of the onboarding app, so that it didn't depend on that having that id up front.

Unfortuantely, when you try to talk this over with your {CEO, PM, Head of Sales}, they glaze over when you try to walk them through the details.
...
Fun alternate version: the tradeoff involves something the engineers are worried about, but the stakeholder doesn't know or care about.
