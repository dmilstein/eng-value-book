...
This was 1991, the internet wasn't on the scene yet. I had a copy of Microsoft C Compiler on a computer [my pre-Windows DOS computer], so I wrote her a C program to transcribe their input document into a table of courses, each tagged with a course code, and each having semester and something else cleanly pulled out.
...
In this book, I'm going to share the core of what I've learned, on each of those fronts.
 ...
 - Turn requests for estimates into an ongoing, collaborative decision-making partnership
...
As fun as it is to write software to solve problems I personally experience (ask me about my .emacs file sometime), it's ultimately been more *rewarding*--both financially and personally--to write software to solve other people's problems.
...
This has meant working embedded in a series of businesses[fn:: I suspect that some of the joy of doing open source work is getting to solve meaningful problems *without* being embedded in a business].

Therefore, I've spent many, many years trying to understand how to solve *business problems*. How to ensure that the work I do, the software I build, ultimately helps the business solve problems for their customers.

As I did so, I ran smack into three major challenges, each of which initially completely defeated me, and each of which I gradually learned how to tackle.

**** Challenge 1 - Estimates

Remember that C program I wrote to prepare the course catalog? I think I told my mother it would take me a week. But, to my dismay, due to both my own learning curve, and to all the weird edge cases I ran into in the input data, I struggled to get it done in under a month.

My mom was fine with that -- they weren't producing the next catalog until later in the summer.

But I was really surprised. I figured that, once I was a better programmer, I'd be able to give more accurate estimates of how long projects might take.

That's turned out to be profoundly untrue.

Especially as I worked to solve business problems, many of which took many months or even years of work for a full team of engineers to work on.

I have found that it is extraordinarily difficult to develop "accurate" estimates of work at that time scale -- in some ways, as we'll dig into in Part I, I've come to believe it's better understand as being *impossible* to do so (it all depends on how you define "accurate", spoiler alert, the best way to do so is in the context of a *decision* the estimate is being used to make)

But the people I've worked with in those businesses have asked, in just about every way imaginable, for such estimates.

In order to solve real problems for the businesses I've worked in, I've had to learn how to lead [drive, execute on] major efforts, where saying "We just don't know how long it will take" was genuinely unacceptable [would prevented the business from making key decisions]
...
Just telling them "I don't know" isn't just bad for you -- it's potentially bad for the business, too.

If you're lucky, you'll have a trusted product management partner managing that stakeholder -- but even if you do, that PM is likely looking to you for estimates of effort.

So that question still falls on you.

You *can* just shrug, and everyone can stumble along, making painful discoveries as you go, often too late in a project to adapt.
...
Working as part of a business means, well, working with human beings.
...
It would be lovely if those humans entered into the relationship with engineers ready to trust the engineers, carefully sharing overall strategic context, laying out a coherent problem to solve, and then being eagerly ready to adapt and learn as the work is done.

But, here in the real world, that aspirational ideal is very rarely met.

In particular, those people commonly:

 - Announce a solution they want built, not a problem they want solved

 - Share limited or no context

 - Demand an ahead-of-time estimate and commitment

 - Are resistant to participating in ongoing reprioritization

What's an engineer supposed to do? If you try to get them into a different mode, they're likely to dig in defensively. If you try to play along with their game, you run a massive risk of the project going off the rails, and it being your fault.

There's a better way!

**** Challenge 3

Over the course of many years of developing software to solve business problems, I  discovered and then became terrified of the challenges of maintaining and extending an existing codebase (including a codebase that I myself wrote in the past, which, fascinatingly, didn't all turn out to be easy to work in[fn:: It's possible that, in 1997, I was bored at my job, so when I had to hack together a script for churning out static html pages, I read through the Perl regex magic variable binding rules and used a series of weird as hell $ variables... and then that script got picked up and used for a dozen projects and I felt compelled to apologize personally to every engineer who touched it])
...
**** Other Way
, and then learned to cheerfully embrace

And none of which were even hinted at, as I was studying computer science or eagerly consuming every book I could find about structuring programs.
...
Most of it has involved work that has taken a good deal longer than the couple of weeks it took me to write that catalog prep program.
