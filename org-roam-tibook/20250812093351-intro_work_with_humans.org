...
We'll focus on steadily making small improvements, building trust and rapport as we go. When trying to improve how you collaborate with a key stakeholder, working incrementally is far more effective than trying to make a single big change all at once. Of course, in this it resembles *every single other* facet of attempting to develop valuable software. If Waterfall doesn't work for adjusting complex software systems, why would we expect it to work for adjusting complex human systems, which bring with them their own delightful forms of complexity?[fn:: I've had software systems fail for an enormous variety of reasons, but, so far, not because any one component took it personally that it wasn't invited to another component's birthday party. Of course, I'm writing this late in 2025, so maybe in a few years soothing moody LLM's will turn into a full-time job?]

In the game plan, an increment of improvement consists of four key steps:
...
But first, let's sketch in a high-level overview of what you'll be doing each of these steps, along with why.
...
You'll pick a specific such adjustment, which, if possible:
  ...
  - Moves you /both/ a little closer to the long-term strategic goal

Then, you'll offer this adjustment to your stakeholder in a carefully structured manner. You'll go through the following four steps, in a sequence that is specifically designed to make it as easy as possible for your stakeholder say yes:
...
Fun fact: this approach steals ideas from two books, one for dealing with teenagers, the other with terrorists! That's Raising Human Beings, by Ross Greene, and Never Split The Difference, by Chris Voss and Tahl Raz. Both are truly excellent! And both are highly relevant to working with your CEO!
...
Once you successfully get through the first period of change, you can:
