...
We'll focus on steadily making small improvements, building trust and rapport as we go.

When trying to improve how you collaborate with a key stakeholder, working incrementally is far more effective than trying to make a single big change all at once. In this it resembles *every single other* facet of attempting to develop valuable software. If Waterfall doesn't work for adjusting complex software systems, why would we expect it to work for adjusting complex human systems, which bring with them their own delightful forms of complexity?[fn:: I've had software systems fail for an enormous variety of reasons, but, so far, not because any one component took it personally that it wasn't invited to another component's party. Of course, I'm writing this late in 2025, so maybe in a few years soothing moody LLM's will turn into a full-time job?]

In the game plan, going through an increment of improvement consists of four key steps:
...
Then, throughout the rest of this book, we'll share a wealth of tactics for working through those steps *with* your stakeholder.

But first, let's sketch in a high-level overview of what you'll be doing each of these steps, and why each is important.
...
You'll start by identifying a single, key long-term outcome (where "long-term" generally means something like twelve to twenty four months out). This is a *business* outcome that your stakeholder is spending their days and weeks and months thinking about. A few examples:
 ...
 - Demonstrating that introducing a new product will increase the total addressable market for your company
...
It enables you to position a request for change as a *necessary step* in eventually achieving that long-term outcome.

It creates the *flexibility* to identify new ways to work together, that still move you towards that long-term outcome.
...
All that is great, but, unfortunately...

...identifying such a long-term outcome often takes real work.

In many cases stakeholders do not clearly share the long-term business outcomes they care most intensely about. They do not share what they, themselves, are working backwards from. Sometimes, they even try to hide it from you![fn:: Because they don't want to "distract" you and your team with "things you don't need to worry about."]

In "Extract A Strategic Outcome" we'll dig deeply into both why stakeholders often fail to share this kind of context, and also what you can do to ensure you're getting past their day-to-day requests, to what they truly care about.
...
Your stakeholder is, unless I very badly miss my guess, a human being.

Thus, like all human beings, their behavior is not driven merely by a rational plan to achieve some long-term outcome. We are none of us robots. If you want to persuade your stakeholder to make a change of some kind, you're going to need to understand their messy human emotions.
...
First off, you'll make absolutely certain your stakeholder has something meaningful to *do*, in this new way of working... even if right now all you are most desperately hoping for is for them to leave you alone. You'll ask them to play a genuinely critical role in this first increment. Perhaps that's making key decisions, or guiding work at certain key moments, or negotiating with other parties on key terms.

Then, as the work unfolds, you'll find small, meaningful wins to celebrate together. You'll steadily connect incremental progress today to the long-term outcomes you are hoping to some day achieve.
