...
We're going to imagine, specifically, that the person struggling with a broken interaction pattern is Janine, an engineering manager at a company that sells a powerful form of B2B software. She leads a team which owns a complex piece of the core, legacy application -- her team has been sprinting towards delivering a significant overhaul of that application, which goes by the code name "Cogs 2.0", internally.

Eduardo, her product manager has, in general, been a good partner -- he offers real context, digs into the details to identify good increments, and manages stakeholder expectations well.

However there is one part of their working relationship which is non-ideal.

Janine has not found an effective way to advocate for dealing with looming technical risks and issues. If she brings up tech debt, Eduardo expresses sympathy, and assures her that they'll find time for it as some point... but then they never do so. As the big launch approaches, the team is getting more and more nervous about all the corners they've cut.

This is a classic way for the engineering/stakeholder interface to be "semi-broken" -- there isn't a way for the engineers to drive investments in things they believe are valuable, that the rest of the business isn't asking for.

# XXX Does Janine already have the idea of SLO's?

In this particular case, Janine's team is worried about how the database is going to handle the change -- Cogs 2.0 has the potential to make a *lot* more requests of the DB, and it's possible those requests could be a lot more complicated. They're pretty worried.
...
But let's practice empathy again, this time focused on the situation Eduardo finds himself in, as Janine goes to him with this request:

Eduardo has *dozens* of other people making *similar* requests of him, *all the time* -- half the sales team, the director of customer success, Phil from the help desk, the company CEO who likes to check up on their favorite customer's requests, etc. All of those peoplea reaching out to Eduardo via Slack, email, casual conversations in the office kitchen, difficult negotiations in front of half the leadership team.
