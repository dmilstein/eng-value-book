...
This is a set of skills which can, ultimately, massively increase your *influence* -- they are way to demonstrate to people see that you truly feel and care about their concerns. Which makes them enormously more ready to listen to *your* concerns, and then work with you to find a way to address both.
...
*Sidebar: Really? Why Do Engineers Needs All This Empathy Bushwa?*

You might well be thinking: /"Sure, Dan, I can see how building trust and rapport is a core requirement of the *product* job, but that's the whole point of having a product team, right? So the engineers can just focus on building stuff, right?"/ Look, sure, these are fundamental survival skills for a PM (so much so that I test for them in PM interviews). But they are also insanely valuable for engineers. As you rise up into any form of engineering leadership, be that management or the technical track, your ability to *influence* peers and executives [bosses, overlords], becomes absolutely central to your ability to create value. That is true both for the subject of this book (driving change in interaction patterns), but also for many other areas.
...
Developing effective influence is the work of a lifetime.
...
Never Split the Difference is *incredibly* good, by the way. It sits very comfortably somewhere in my top five list of "Wait, you should totally go drop everything and read this" books.[fn:: Others that threaten to be in that top five include "Escaping the Build Trap" by Melissa Perri, "The Principles of Product Development Flow" by Don Reinertsen, "Designing Data-Intensive Applications", by Martin Kleppman, "High Output  Management" by Andy Grove, "The Art of Action" by Stephen Bungay, and "Eleanor & Park", by Rainbow Rowell]
