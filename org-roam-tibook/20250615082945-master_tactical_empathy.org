...
I think it's legitimately hard for most engineers to imagine just how well and truly miserable it is for stakeholders to work with an engineering team.
...
You've done a little bit of work on the side, to build some basic visibility -- but you believe now is the time to take the next step of investment: developing good SLI's and SLO's[fn:: The first few chapters of O'Reilly's Implementing Service Level Objectives are an incredibly good game plan for this]. Doing so is going to require a real chunk of engineering time, *and* a commitment of time from the product team (good SLI's must be developed in collaboration)

You could go to your product counterpart and lay that out as a proposal, al:
...
But, again, let's practice empathy again:
...
To a first approximation, Product's *job* to continually disappoint everyone around them.

And that includes engineering.

So, what can you do, to move your requests higher on their list?

As Voss makes clear his his book, if you want someone to *listen to you*, you are incredibly well-served by *first, listening to them*.

But it takes a bit of work to get most humans to share what they're thinking and feeling. So we're going to use a few tricks.
...
They respond with a, typically brief, answer.
...
Iif you can achieve any form of genuine curiosity as you speak, and if you can stop yourself from saying anything other than those three words...
...
In our example, let's start by imagining that the engineering leader does *not* have this skill, and let's see how the conversation might go.
    ...
    ENG: If we don't do the work now, I bet we're not going to find time for it before peak. We're only talking about three weeks, we can timebox it you want.

    PRODUCT: Okay, I'll think about it.

The Engineering leader is trying to speak to value, which is good.

But most product leader would experience this as someone *pushing* them for something.

And a, like, core survival skill for a PM is being able to ignore people who push them for things. They couldn't get through a single day without doing so.
