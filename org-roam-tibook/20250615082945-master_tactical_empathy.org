...
#+filetags: :Chapter:
* Echoing Back: A Core Empathy Skill
...
Accessing that kind of curiosity can mean quieting a sense of fear. It can mean asking the part of you that is hitting the internal panic button to take a smoke break. It can mean deluding yourself into believing everything is going to be just fine, no matter what.

It can sometimes mean unhooking the part of your brain worries about whether or not you'll be percieved as intelligent or experienced (which is a totally natural thing to be worried about!)
