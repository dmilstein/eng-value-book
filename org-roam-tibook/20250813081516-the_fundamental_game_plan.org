...
In this case, the engineering lead should likely start by advocating with the VP of Product.
...
Focusing on one person at a time is very powerful.
...
Unfortunately, when Quin gently suggested to the Marco that he not feature bomb the team so often, he rejected the idea without missing a beat. "Look, we're a *startup*," he said. "We have to move *fast*. I need the team to hear everything from customers right away, we can't wait for some artificial process."
...
Given that her attempts to address things at a "tactical" leve failed, Quin decides to back up  a bit, and start by aligning at a higher level, instead of advocating for any specific changes.
