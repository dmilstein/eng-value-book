...
Given that her attempts to address the problem head on failed, Quin backs up and decides to start by *learning more about what Marco's feelings*, instead of advocating for any specific changes.
...
Finally, she pauses and looks through her notes. "Let me see if I've got the overall story," she says. She then steadily works through her notes, giving a clear and concise a summary of everything they've just discussed.

"Does that sound about right?" she asks Marco, one final time.
...
Unfortunately, we've already seen that Marco has a way to discount that -- "We're a startup, we have to move fast."[fn:: "Dan, why don't you just /explain/ to Marco that ATN! will /actually/ move faster if he just chooses a single goal?". In my extensive testing in the field, trying to *intellectually* convince someone to change their behavior works, let me check my notes here, approximately *never*.]

Having drawn out from Marco a statement of intent, Quin could instead open her pitch for change with something like:

"As I understand it, ATN!'s most important goal is to have a set of *engaged customers* within six to eight months--meaning, customers who are regularly using the platform. To get there, we need to get something concrete in the hands of a few actual customers as quickly as possible, and then improve based on what we learn." She could then check to see if that sounds right to him, before continuing with, "Unfortunately, I'm worried that the team is struggling with shifting priorities, and we might miss our targets for shipping something customers can start *using*."

Marco is hugely more likely to listen to that latter concern--both because it's speaking to key overall business goals, but also because it's *using the words he himself uses*.

Fun fact: just *stating* that overall strategic goal can make a big difference. It positions you as discussing what is best for the business, *not* your own "personal" frustrations.
...
She needs an understanding of some of Marco's underlying *emotions*. Specifically, she needs to answer The Four Key Questions:
...
Note, it's not necessary for her to get this exactly right on the first try. Because she'll be working iteratively, she can update and adjust this as she goes. She needs a useful working hypothesis of those things.
...
Quin could use her echoing back and summarizing skill to "mine for" these answers. But, in this case, she has worked closely enough with Marco that she has some pretty good guesses.
 ...
 - *What is currently frustrating Marco?*
   ...
   Quin is pretty sure it's the lack of *velocity*. She can tell Marco feels like it takes forever for him to see any progress on the product--and that's why he's starting to suggest she put more pressure on the team to work longer hours.

 - *What is Marco afraid of?*

   Quin has heard him speak about engineering teams he's worked with in the past, who missed all their deadlines, didn't let him know in advance, and left him completely in the lurch.
 ...
 - *What makes Marco feel good?*
   ...
   He lights up when he has a chance to interact with a visual prototype.

   He also clearly deeply enjoys sharing what he's learned in the field with the team. Quin guesses that part of that is because Marco is using those debriefs to clarify his own thinking. He comes in swirling with thoughts, and by the end, he's condensed it down. Unfortunately, the team is dizzied by all the ideas.

 - *What does he dream of or hope for*?

   Sharing something exciting with customers that they can't wait to start using.

   Quin has also heard him say more than once that he wants to build a company where everyone feels connected to the customers. She suspects that his constant updates from the field are partly motivated by that vision.
