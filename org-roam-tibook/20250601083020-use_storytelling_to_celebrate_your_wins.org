...
Enabling parallel development across multiple teams is *incredibly* valuable to a business -- but can only enabled by smart, deeply technical investments.

Don't do it speculatively (aka, don't build microservices until you have a successful but quite frustrating monolith).

But if, as above, you've got specific product strategy goals, finding a way to both *make* these investments, and as above, *tell the story* of the value created, is one of the most valuable things an engineering leader can do.
