...
But you can use the structures and tactics of storytelling in a wide variety of contexts -- and *not* just in places where your listeners are "consciously expecting stories":
 ...
 - When you're presenting to a roomful of executives, to dive deep on options that have been turned up by some technical investment you've been leading.

 - When you write up and share out the results of a post-mortem or retrospective

Fundamentally, the human mind has a penchant for narrative.

You can take advantage of that penchant, in many different contexts.
