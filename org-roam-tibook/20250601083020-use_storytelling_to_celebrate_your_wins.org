...
"The Rapid Restore project, which had a goal of reducing the time to restore a full database of customer data from a backup. We depend on being able to restore from backups for everything from routine development work to protecting us from the risk of permanently losing critical customer data. Which we really, really don't want to do."
...
** Step 1: Open With a Teaser
/ Book Cover / Movie Poster / Why Am I Here

** Step 2: Create A Fundamental Arc

** Step 3: Turn Events Into Moments in Time
