...
:END:
#+title: The Profound Value Of Good Increments
#+filetags: :Chapter:
* Help Us, Good Increments, You're Our Only Hope
...
As you work on steadily larger programs, you learn some key lessons -- e.g. wire the components together early and often, to flush out any confusion around interfaces. Write automated testing so you can safely restructure the system as you go. Use abstraction to capture repeated patterns. Then, after you excitedly overuse abstraction and create extremely difficult-to-change systems, learn to employ abstraction judiciously.[fn:: I find a hallmark of a truly experienced engineer is a willingness to cut and paste, like, a *bunch* of times, until they're certain they fully understand the pattern they want to pull out.]

But, there's a problem.

These skills, though extremely useful, turn out to be insufficient when you're confronted with the challenges of developing valuable software for a business.

Why?

I'll offer three reasons.

First off, when you work in a business, Some Important Person will demand that, before you start, you tell them *how long* it's going to take to write your program. After some *very* painful experiences, you realize that you can't answer this question in any meaningful way.
...
So, problem one is: even though Everyone Knows how hard it is to estimate software projects that stretch out past a few months... you're constantly asked to make long-term commitments.
...
Again, you seem to have two equally unpleasant options:
 ...
 a) Not My Problem! Put your head down, write lots of code, take pride in the code you write, and completely disassociate from any hope of creating value or solving meaningful problems. Assume a stance of cynical bitterness.
...
What are your options?
 ...
 a) Just pile more on top of the unstable foundation, and hope that the resulting problems land when you've moved on to another project, company, or career. Give up on any pride in building quality software that you can be proud of.

 b) Insist on rewriting the existing system to clean it up. This sounds like a great idea until you convince some credulous Important Person to let you do it, and then you discover the horrifying death treadmill of the Grand Rewrite. You leave that job before the rewrite finishes.
...
Furthermore, for a business to create value through building new software, the design of increments should be a centerpiece of a collaborative conversation among engineers, product managers, and their stakeholders.
