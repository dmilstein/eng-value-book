...
However, in the case of software projects, it's made specifically difficult thanks to one simple reason:

# extremely, fascinatingly,

# *It's impossible to define all the steps before you start the work*.

*It's impossible to define all the steps up front*.

This is so widely accepted that software engineers and product managers will dismiss the "define all the steps first" approach with a casual, patronizing, "Ugh, you're asking us to do /waterfall/."
...
Well, to successfully build a large piece of software, you apparently have to start by *somehow* selecting one specific chunk of work, executing on that chunk, and only then choosing your next chunk.
...
Thus, because the steps can't all be defined ahead of time, the core act working incrementally is /deciding what to do next/.

The fundamental thesis of this book is that deciding what to do next is an incredibly high-leverage act.

That act is best understood not as merely selecting from some set of fairly obvious alternatives, but as a challenge, requiring creative engineering and product management  effort to overcome. Good increments of work aren't merely chosen, they are *designed*. I believe that increment design is among the most critical, valuable skill for engineers and product managers to develop.
...
Over the course of my career, I've come to believe that increment design is one of the most valuable skills of experienced engineers and product managers.
...
No, for a business to generate value from a large software effort, the business must steadily make decisions as the work unfolds. There must be a given and take, as information is acquired, new increments are selected, and the ramfications filter through to the business as a whole.
