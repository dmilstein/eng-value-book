...
This book is a deep dive into how to design effective *increments* when developing software.

By "increments" I simply mean: how to break up a large body of engineering work into a series of smaller steps.

I have come to believe that effective increment design is perhaps the most important skill of experienced engineers.

I further believe that the design of increments should be a centerpiece of a collaborative conversation among engineers, product managers, and the rest of the business.

Why?

For one simple reason: a good increment is one which *creates incremental value* for the business as a whole.
