...
Unfortunately, few Important People wake up every day eager to vulnerably share their feelings (that said, if you have such a leader, awesome! Maybe just directly ask them some of the questions below)

Fortunately, there are excellent ways to get past that initial shell.
...
As we develop our skills for mapping feelings, we'll be guided by four key questions. You don't necessarily need to answer every one of these questions in every situation, but they represent a very useful set of ways in:
...
If you can come up with answers to these four questions, it will hugely help you when you make a request to try something new. We'll spend real time on how to craft such a request in the "Make a Compelling Offer" chapter.
