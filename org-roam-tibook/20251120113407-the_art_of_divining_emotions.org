...
Of course, very few Important People wake up every day eager to vulnerably share their feelings.

If you happen to have an emotionally open stakeholder, awesome! Go ahead and just directly ask them the questions below. If, on the other hand, your stakeholder presents an armadillo-like shell to the outside world, read on for some powerful ways to help them open up.
...
As you develop your skills for mapping feelings, you'll be guided by four key questions. You won't necessarily need to answer every one of these questions in every situation. But, in total, they represent a very useful set of ways in:
...
If you can come up with answers to these four questions, you can develop a really strong pitch for change. We'll talk about how to craft your request in "Make a Compelling Offer."
...
First, you can start by simply *guessing*.

If your stakeholder is in a position of authority within your company, you likely have a hunch about how to answer these questions. The emotions of people in power are important enough that, usually, people on the ground have at least *some* model of what is going on inside their various bosses' heads.

Let's see how to talk to your stakeholder so you can then refine, adjust and potentially altogether change your initial guess.

** Look Who's Not Talking Now: Humans Resist Sharing

# , Well, Anything

# How Alistair Gets Max Talking

Let's return to our story of Alistair and Max. First, let's *rewind*.

In the last chapter, we showed Alistair building rapport with Max thanks to knowing: a) Max feels like the CEO will angrily blame him if any customers suffer any confusion whatsoever, and b) Max is worried because the new PM's don't fully understanding the core, complex ProClaims product.

However, we skipped past *how Alistair would figure those things out*. Max certainly doesn't go around *explaining* those things. He just rigidly insists that he has to be in the loop for all decisions, he plays out his martyr complex, he looks tense and unhappy.

Alistair experiences Max as brusque, remote and difficult. He doesn't realize there's any tension with the CEO. He doesn't know that Max has concerns about the PM's. He assumes Max's difficult behavior is due to Max's difficult personality.
...
Alistair can tell that Max is frustrated during their weekly ProClaims status meetings. He's not totally clear on *why*. His current theory is that Max is unhappy that the project seems to be drifting behind plan.

How can Alistair learn more?

In a pause during one of their zoom check-ins, Alistair takes a breath and says: /"Is there anything about our ProClaims status meetings you find frustrating?"/

Max looks taken aback. He frowns and then curtly replies:
...
Many stakeholders (and, frankly, many humans, period) tend to clam up, the moment anything resembling an emotion drifts into view. Expressing their own emotions feels risky and vulnerable.

This is a genuinely tricky moment.

Imagine you've asked your key stakeholder a question you care a lot about. Imagine that they've immediately shut down the conversation with a terse response.
...
What should you do? Ask another question, and piss off your Important Person? Try to somehow divine your key answer from whatever cryptic, fragmentary thing they said? Give up and go home and pour yourself a stiff drink? I have tried all of those, many times.
...
When Alistair's asked about the ProClaims status meetings, all Max said was:

/"They feel a bit slow."/

In reply, Alistair looks at Max, and says, calmly:
...
There's a slightly shorter pause before Max starts talking. /"Yeah,"/ he says. He sighs unhappily. /"And I can't blame the engineers."/

This remarkable statement almost makes Alistair break down, but he manages to stick to his plan to draw Max out. /"Blame the engineers...?"/

Max replies quickly. /"Yeah. I don't think the PM's even really understand the product."/

Alistair is startled to hear this statement of concern from Max. Max hasn't complained to him about the PM's even once before this. Max has "blamed the engineers", plenty of times, but up to now, Alistair had been assuming Max was on the PM's side, in all of their debates.
...
The trick is to carefully go through two steps, which Chris Voss names "Labeling" emotions:
 ...
 1. Empatheticly describe the situation your stakeholder is in
