...
Alistair has learned something new and fascinating: that Max is frustrated by how poorly the PM's seem to understand the product. That feels like it might be a root cause of some of his problematic behavior.

Alistair is feeling slightly unmoored. For once, Max isn't tensely checking his watch or looking at some other screen. He's genuinely with Alistair. What should Alistair do next?
...
So let's first review a series of other things he might try:

*** Offer To Help

This is one of the most common responses.

Alistair has heard Max share a problem to solve: the lack of knowledge of the product, on the part of the PM's. Therefore, he could offer solutions:
...
Alistair is acting as if Max is *asking for help* in solving a problem. But that's not what Max is doing. He's tentatively sharing his feelings.

If Alistair jumps ahead to solutions, he causes two major problems:

 1. Max feels "not heard"

 2. Max feels like Alistair thinks Max is stupid

Put yourself in Max's shoes. You're trying to get someone to understand why your situation is challenging. But that person, who doesn't seem to really understand your situation, starts telling you what you should do. That feels super frustrating. It's like they think you're stupid, and think they're so smart they can fix your problem that they barely understand at all.

Note that this will happen, *even if your idea is a genuinely good one*.
...
*** Bluntly Tell Max How Max Is Feeling

/"You seem pretty upset with the PM's"/

How much do you think Max likes being told his feelings? Right, not at all.

** Tactic: Offer Labeled Feelings

The trick to speaking directly about feelings is to carefully go through two steps, which Chris Voss names "Labeling" emotions:
