...
If you happen to have an emotionally open stakeholder, awesome! You can just directly ask them some of the questions below. If, on the other hand, your stakeholder presents an armadillo-like shell to the outside world, read on for some powerful ways to help them open up.
...
As we develop our skills for mapping feelings, we'll be guided by four key questions. You won't necessarily need to answer every one of these questions in every situation. But, in total, they represent a very useful set of ways in:
...
But first we need to figure out how to answer these questions in the first place.

Fun fact: you can--and usually should!--start by simply *guessing*.

If your stakeholder is in a position of authority within your company, you likely have a reasonable hunch about how to answer these questions. The emotions of people in power are important enough that, usually, people on the ground have at least some working model of what is going on inside their various bosses' heads.

You can then use the below tactics to refine, adjust and potentially altogether change that initial hypothesis.

For example, Alistair might have a pretty strong guess that Max is frustrated by how their existing project status meetings run. That said, he might not be totally clear on *why*.

** Tactic: Repeat Trailing Words

If you want to understand your stakeholder's fears and dreams, you're going to need them to talk to you. But it's often hard to get people talking at all. For example, imagine Alistair asks Max:

/"What about our project status meetings is frustrating to you?"/

Max might shrug and say, /"Not much. They feel a bit slow."/ And then turn his attention elsewhere. He's certainly not inviting any follow up questions. Alistair likely feels rebuffed. All meetings feel slow. What is he supposed to do with that?

There's a surprisingly simple tactic that helps a great deal in this situation. It is so incredibly dumb! And it works so shockingly well!

We'll name it "Repeat Trailing Words", and it works as follows:
...
It shouldn't be this simple. But it totally works.[fn:: If you happen to like romantic comedies, you might catch this *exact tactic* being referenced in episode <something> of Nobody Wants This, in the fun B storyline of the two loser siblings (look, yes, I'm low-grade obsessed with romcoms)]

Let's see it in action, with Alistair and Max.

First we'll show the challenge, and then we'll lay out the tactic:
