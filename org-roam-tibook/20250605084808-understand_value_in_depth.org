...
Of course, the company (or owner) might decide to *invest* some of those profits in hopes of future growth (aka even greater profits in the future).
...
Then, humans, being human, treat the number as Very Meaningful, because Math Has Been Applied.[fn:: If you take nothing else from me, please believe that Guesses + Math = Guesses]
