...
The Math doesn't make the uncertainty go away.

And, the guess, the *uncertainty*, about future profits will just about always be a dominating factor in the valuation of a company.
...
We're going to abstract away all the details of the financial models, and define the value of a company as:
...
A company valuation represents a probabilistic estimate based on current knowledge.
