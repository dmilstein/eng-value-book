...
That understanding can, over time, meaningfully help your career -- because it will allow you to find creative ways (that no one is asking for!) to generate major, visible business wins.
...
The value of A Thing is defined, by our friends the academic economists, as *what someone is willing to pay for the privilege of owning That Thing*.
...
E.g. discounting cash flows to their net present value does matter, but that adjustment will get completely overwhelmed by some real world change in the market, like a competitor emerging who starts to steal all your best customers.

Or by your company successfully developing a new product that customers love and immediately doubling sales in a year.
...
Conversely, if the investor learns that the company has shipped a crude version of a new product to a few early adopters, and those customers are banging down the door for more, then, based on that information, the investor would revise their estimate of future profits upward.
...
Preparing for a funding found *means* trying to assemble evidence that there is a high probability of future profits.
...
This is an outstanding question you're asking!

Different investors have *very* different information.

Different investors also apply *very* different belief systems to that information, to develop estimates of future profits.

Your CEO, for example, might know all about early adopter use of a new product, *and* might ascribe extremely high likelihood of future increases in profits, based on that (your CEO is, just maybe, a tad optimistic in that estimate?).
