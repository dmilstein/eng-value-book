...
To define a specific increment, you'll go through the following four steps:

 - *Map from your team's day-to-day work to your company's strategic goals*

   Lay out the steps in a logical chain that lead from what your team is (or could be) doing, right now, to what the business is trying to achieve, a year or more from now.

   Given that, how could small changes in how you work with your stakeholder increase the odds (even slightly) of the business achieving their long-term goals?

   It's important to start here for two reasons. First, because this should help your stakeholder find your offer compelling. Second, to keep yourself *honest*. Do your current frustrations, well, actually matter? If so, why? Make sure you can see the connections.

 - *Identify what frustrates your stakeholder, in the current situation*
   ...
   If there is nothing frustrating for your stakeholder, you might need to use some advanced tactics. See the later section on "Creating Urgency".

 - *Identify what your stakeholder likes about the current situation*

   Your stakeholder will often be afraid that, if things change, they'll lose something they currently value or enjoy.

   You want to know what they might be afraid of losing, so that you can carefully address that in your request for change.
