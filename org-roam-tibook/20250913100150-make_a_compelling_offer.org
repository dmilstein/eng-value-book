...
Thus, to equip you with a wide set of options to work with your very own Important Person, I'm going to share a broad set of tactics for first developing and then delivering this kind of offer.

For each tactic, I'll first name a problem you might run into with stakeholders, and then sketch in the corresponding action you could take. I've grouped them into three thematic blocks, corresponding to challenges with:

 - Coming up with a specific incremental adjustment

 - Getting your stakeholder to take your concerns seriously

 - Getting another human being to change their mind

Below, I'm going to list all the tactics in summary form. In the next few chapters, I'll explore the tactics in more detail.

** How To Design An Incremental Change
...
** How To Work With Another Human
