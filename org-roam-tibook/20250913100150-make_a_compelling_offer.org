...
You know your stakeholder is going to be reluctant to consider a change in their behavior.

*Example*

You say to your PM, /"During planning, even though I know time feels tight, could you please spend more time sharing context with the engineers?"/

This is an open-ended request for change. Saying "yes" could feel like making some kind of long-term commitment. Your PM might well pause.

*Solution*

Ask your stakeholder to just try changing their behavior for an initial, limited period of time.

/"For our next *two sprints*, could I ask you to spend some time laying out the ‘Why’ behind the epics, before we get into the detailed tickets? We can see how that goes, and if we're tight on planning time, I can work with you to streamline grooming and pre-planning."/

*** Offer A Future Decision

*Problem*

Your stakeholder is a human being. Therefore, agreeing to change their behavior /because someone asked them to/ makes them feel like they're losing control.

*Example*

You say, /"I want the team go off and spend a month in heads-down exploration, without having to constantly report back on status to you and me as they go."/

Your stakeholder, who already feels like they're struggling to keep the work on track, is being asked to give up even more control! They push back.

*Solution*

Ensure that your initial, timeboxed increment of change ends with a *decision that your stakeholder gets to make*, so they still feel in control over the process.

/"I'd like to ask for the team to do a month of heads-down exploration. At the end of the month, they'll sit down with you and do a thorough deep dive on everything they've learned, so *you* can decide if they’ve found something worth committing to. During the month, I'd like to let them go fast, without having to report back on status to you and me. That should give us a good shot at having a lot of info for you to then review. Can we spend some time aligning on what key info you'll want to base a decision on?"/
...
You're worried that your team is toiling long hours in the feature factory. You know you could create hugely more value and find your job way more fun if only:

 - The exec team would set high-level strategy instead of obsessing over features

 - The product team would turn that strategy into a series of outcomes instead of developing sprawling project specs

 - The engineers could learn how to collaborate around outcomes instead of just chewing through tickets as fast as possible, as they do now

That's all genuinely great, but good lord, so many moving pieces to get right.
