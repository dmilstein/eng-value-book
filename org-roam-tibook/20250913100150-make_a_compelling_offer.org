...
I have promised you a step-by-step game plan for gradually drawing your Important Person into an ongoing process of collaborative problem-solving. I have insisted on steadily making small improvements, building trust and rapport as you go. I have claimed that each incremental improvement will involve the following steps:

 1. Develop an actionable *statement of strategy*

 2. Build an *empathetic understanding* of your stakeholder's concerns

 3. Use a *compelling offer* to obtain a short-term commitment

 4. *Ensure a win* that creates good feels
...
Through some diligent probing, Alistair has manged to extract a coherent strategic outcome: in order to keep growing, AccuraClaim needs to capture more revenue per customer. They've set a goal of increasing their average price to $1.50 per insurance claim processed. Alistair has been able to work backwards from that goal to his team's day-to-day efforts to fundamentally restructure the core ProClaims product.

Furthermore, Alistair has identified two key emotions:
 ...
 - Max is *frustrated* that the recently-hired PM's don't fully understand the existing ProClaims product

   And Alistair agrees that the lack of nuanced understanding on the part of the PM's makes it legitimately difficult for Max to step back.

   (Alistair also suspects that Max has a weakness for heroically martyring himself, so "I can't possibly delegate!" may be a well-worn path in his psyche)

# But, in this particular case, Alistair actually agrees that the lack of nuanced understanding on the part of the PM's makes it legitimately difficult for Max to step back.

Finally, through the process of learning these things, Alistair has been able to build some rapport with Max.
...
It's the evening of that surprisingly successful conversation. Alistair and his husband, Carl, have finished dinner and cleaned up. Carl is taking their dog for a walk around the neighborhood.

Alistair sits down at his desk, crammed into a corner of their bedroom. He spends a few minutes trying to collect his thoughts about how best to approach his meeting with Max. He  writes out a set of bullet points. Then he deletes all those bullet points. Then he writes out a new set of bullet points. Then he deletes all of those. He stares blankly at his laptop screen. Finally, he gives up and texts Naiah, his husband's social worker friend. Luckily, she's free to talk.
...
"Well, I don't know if they're /great/, but yes?"
...
# I want to exaggerate just a bit. Getting the details of this little dance right really really pays off. But it can feel sort of oddly specific.

# Where he doesn't observe various steps in that list. We'll see how things would play out with him and Max.

After we've gone through all of those, we'll see how he can successfully get a commitment to try something new out, for a limited period of time.
...
** Failure Mode 1: Jump Right Into Your Plan
...
"Exactly," says Marvin. "That works literally every time."[fn:: In my mind, Marvin now toasts him with a martini glass filled with a glowing green cocktail. Is it possible I'm drawing on Marvin the Martian from Bugs Bunny? How would he mentor people? With his little helmet covering his eyes? Hmmmm.]

The next day, Max takes the subway to the downtown office space that ProClaims maintains (it is largely empty today, as it is on most days).

Max, on the other hand, has forgotten what this meeting is even for. Since they had their brief moment of connection yesterday, Max has:

 - Received seventeen urgent Slack messages from people
 ...
 - Cancelled three one-on-one's with his increasingly-desperate direct reports

 - Spent forty-seven bitterly frustrated minutes composing a reply to his CEO's deceptively casual request to know if "the ProClaims work was back on track, and if not, when the devs could commit to achieving full feature parity," every word of which request seemed to require a novella-length explanation to unpack (what does the CEO think "on track" means? Does the CEO perceive a failure on the part of the devs to "commit"? When did "full feature parity" metastasize, tumor-like, in the CEO's mind, since it's never been something Max has promised, even once? Max's fingers shake as he types.)
...
Max nods. Maybe this is a meeting about training the PM's? That rings a vague bell. But he doesn't have much time to spend on that. He checks to see if there's a reply from this CEO to his epic Slack from this morning. Not yet.
...
You can never repeat the context too much.

# Take 2, Alistair opens with the strategic context.

# But then he goes straight to the plan.

You can never validate their feelings too much.

# Take 3, Alistiar validates the feelings
...
** TODO Try reordering the story and the approach
** TODO Playful options for showing failure modes
