...
Problem: You've linked your current frustrations to longer-term strategic outcomes, but that linkage feels dry and unconvincing.

Tactic: Lean on storytelling structures to make your concerns *feel* vivid and immediate to your stakeholder

Evolution has wired storytelling structures deeply into the human mind, so using them to frame your concerns can have a big effect.

There's a specific structure, a form of the Heroic Arc, which is somewhat shockingly useful for framing business challenges. It goes like this:
...
How can you use that? What am I even talking about?
