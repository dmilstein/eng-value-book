...
...they hear this as a request to make a permanent change.

Their brain whirs up into action, quickly coming up with reasons to say "no"---you barely have enough time to get through all the tickets already, it'll take forever to share all that context, that one scary engineer always glares at them when planning runs long, etc, etc.
...
After your team shares updates and options with your CEO, they have this extremely frustrating habit of holding forth for five minutes about all the other things the team *could* be doing. Then, once everyone is good and totally confused about priorities, the CEO briskly says "Thank you," stands up, and leaves the meeting.
...
Find a non-judgmental way to describe the /results/ of their behavior as a problem for the two of you to solve together. Ask them open-ended questions that offer them a chance to cleverly solves this problem. As part of that, play "low status".
...
You might be tempted to sweep this under the rug, by just focusing on the positive, and therefor avoiding conflict. But when  you say, /"We're proposing to strongly focus engineering time on the new product, because that's the core of our company strategy"/...

...your VP of Sales hears an invitation to start /arguing/, since you don't seem to understand the retention risk this will cause.
...
Make it easier for them to say yes by making it clear that you will personally take on extra work, and/or face some hard thing.
