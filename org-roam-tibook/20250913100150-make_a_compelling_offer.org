...
First, the parent develops an empathetic understanding of what the child needs, wants, and feels. In other words, what the two of them need to solve for, if they're going to find a solution that satisfies *the child*.
...
Second, the parent then shares what *they* need to solve for. This almost always requires them to give up on their (intense!) desire to tell the child /what to do/ (e.g. "Pick up your clothes!").  Instead, they need to identify their own underlying /needs/ (e.g. "It's important to me that the living room stays clean.").

Third, the parent invites the child to collaborate with them to find a solution that works for both.
...
We'll develop a compelling offer to your stakeholder by following that same arc. We'll open up the first step a bit, by stating the *shared* goal of the strategic outcome. So our four steps are:
...
It's the morning. Jean is finishing her breakfast and getting ready to start her workday. She sips her coffee. She checks the clock over the stove. She sips her coffee. She checks the clock over the stove. The hands are ticking closer and closer to seven forty-five. Jean frowns. She can't possibly drive Griffin today, she has a zoom call at eight. Is he assuming she'll give him a ride? That would be typical. She listens for footsteps upstairs. Silence. Tick, tick, tick. The clock reaches seven forty.
