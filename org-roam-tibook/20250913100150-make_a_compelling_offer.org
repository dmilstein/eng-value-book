...
#   - Ensuring something improves for them, in the short term

#   - Ensuring you're aware of anything they might feel like they're losing
...
# In order to prepare a compelling offer, your first step is to precisely define the new, slightly better way you want to work with your stakeholder. In so doing, you should build on all you've learned about both the long-term strategic intent and your stakeholder's suite of feelings.
...
To define a specific adjustment, I recommend going through the following four steps in some order. Personally, when I do this work, I tend to loop around, jumping back and forth and refining, eventually honing in on something.
 ...
 - *Map from company strategy to your team's day-to-day work*
 ...
 - *Find wins for your stakeholder*
   ...
   Beyond speaking to the long-term goals, ideally, you want to pair your ask for a change with an offer to improve *something* for them. That could be removing something that is actively frustrating them, or promising to give them something that they want, but aren't currently getting.
 ...
 - *Identify potential losses for your stakeholder*
   ...
   You want to know what they might be afraid of losing, so that you can carefully address that in your request for change. Sometimes that means reassuring then that they won't lose that thing, sometimes it means supplying them with an alternative. And sometimes it means directly asking them to give it up.

 - *Define a slightly better way to work*

   Where it's slightly better for you, your stakeholder, and the business.

   Make sure it ends with your stakeholder making a decision.

   See if you can find a way to Put Yourself on the Line.

   Be ready to spend some real time thinking about this. In my experience, there isn't usually an immediately obvious first increment. It takes some creative design. Talk to some friends about good patterns of work, test out your thinking with people you trust. Sleep on it, and see if any new ideas come to you the next day.
...
You need to develop a logical chain that leads from what your team is doing, right now, to what your business is trying to achieve, a year or more from now.
...
** TODO Rename "Identify Frustrations" to Enticing
