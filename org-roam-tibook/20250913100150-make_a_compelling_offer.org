...
Why this pedantic distinction between "personality" and "patterns of interaction"?[fn:: I mean other than the obvious fact that I love pedantic distinctions. I may not yet gotten the nickname Dan 'Pedantic Distinctions' Milstein, but it's only a matter of time.]

Focusing on behavior makes your concerns far more *actionable*. It sets you up to make a request of your Important Person to change that behavior, initially in some small way. Although that's still a pretty tricky request to make, it's way, way, *way* easier than asking them to *change their personality*. You're going to have much better luck asking your COO, "Could we maybe try out a new approach to our planning sessions?", than asking them, "Could you maybe try out not being such a dick all the time?"
...
As a /completely unsurprising/ result of the constant context switching, it's been months since Deanna's team has gotten anything meaningful done. It's like she can feel their startup's cash runway burning to nothingness, every time they randomly switch gears. They'll never deliver anything if they can't commit and focus, but she can't seem to get Karim to change his behavior.
