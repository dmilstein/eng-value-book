...
This four step approach works in an incredible variety of situations. It speaks to a deep part of the experience of being human.

But it is /also/ one of those easy-to-describe but fascinatingly-hard-to-do-in-practice kinds of things.

To equip you with options to work with your very own Important Person, below is a delicious smorgasbord of tactics for developing and then delivering a compelling offer.

In the next chapter we'll dig into each tactic in more detail.
...
# Below, I'm going to list all the tactics in summary form.
 ...
 - Propose a Timebox
   ...
   Solution: Ask your stakeholder to try out a change in their behavior for a *limited period of time*, and promise to review how it's going at the end.


 - Offer A Future Decision

   Problem: Your stakeholder is human, and thus, they resist changing their behavior /because someone asked them to/.

   Solution: Ensure that your initial, timeboxed increment of change ends with a *meaningful decision that your stakeholder gets to make.* This securely positions them in a high-status place of control.
