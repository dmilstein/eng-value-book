...
Problem: You need to ask your stakeholder to *stop* doing something. You're worried that they will resist, because they are a human being, and thus like *doing stuff*.

Tactic: Find a way to ask your stakeholder to *start* doing something new, *instead* of their existing behavior. Allow them to channel their energy into that new thing.[fn:: If you've ever had small children, you may recognize this as a familiar tactic. Someone once explained to my wife and I that, instead of angrily saying, "Stop poking your sister!" we should give calm and extremely specific directions that would result in our son no longer poking his sister. E.g. "Put your hands in your pockets." This has served us quite well! I'm not saying you should treat your CEO like a toddler. Or, wait, maybe I am? Look, we're all humans here.]
...
Examples:
 ...
 - "Stop demanding high-stakes commitments to long-term estimates" -> "Demand that the teams demonstrate that they deeply understand the underlying business goal and are steadily offering options to achieve it"[fn:: This one is so easy! I will leave the details as an exercise for the reader.]
...
Problem: Your proposed adjustment might raise fears for your stakeholder.

Tactic: address their fears *directly* in your request for change.

"Addressing directly" means, more than anything, *validating* the fears. Sharing your genuine understanding of those fears as reasonable, even *inevitable*.

Once you've done so, you have a handful of options for speaking directly to your stakeholder's fears:

 - *Create shared visibility*

   Ensure you and your stakeholder can *both* see if/how those fears are coming true

 - *Offer meaningful control*

   Ensure your stakeholder has something they can *do*, to prevent those fears from coming true

 - *Own the risk with empathy*

   Directly own the possibility of the fears coming true, and the potential impact on them. Situate it as part of something worth doing, and ask them to take that chance with you.

And now, a warning, with the giantest of flashing red lights:

DON'T TRY TO *CONVINCE* YOUR STAKEHOLDER THAT THEIR FEARS *WON'T COME TRUE*.

Note: this path, despite being a terrible idea, can be *enormously* tempting.

You know that your ask could make life harder for your stakeholder. Having that hanging over you doesn't feel good or safe. As a result, some part of your brain will desperately try to convince you that it simply won't happen. Once it convinces you of this, your brain will then insist that, if only you can explain that to your stakeholder, everything will be fine. This path feels easier to your brain than *admitting* to your stakeholder that there is, in fact, anything to be afraid of.

But, telling someone who is being asked to take a risk: "Don't worry, it'll be fine", will make them feel like you're minimizing them and their concerns. It often even sounds *patronizing*.[fn:: In which case, game over. This entire effort is a loss and you'll want to back way the heck up and start over.]

Address the potential dowsides, the fears, directly, clearly and with empathy. Make the risks visible, offer them control, of just own that you're asking something hard. Don't avoid, minimize, or skirt around.
...
For example, your stakeholder might hear a request to

Sometimes, addressing directly means making it clear that you understand and are committed to

Other times

If you can, make clear to them that they'll still get that benefit, possibly in a new way. If, on the other hand, they do just have to give something, make that very clear and express your empathetic understanding.
