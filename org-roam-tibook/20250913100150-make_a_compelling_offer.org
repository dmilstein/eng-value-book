...
Thus, to equip you with a wide set of options to work with your very own Important Person, I'm going to share a broad set of *tactics* for first developing and then delivering this kind of offer. For going through various parts of the four step approach.

For each tactic, I'll first name a problem you might run into with stakeholders, and then sketch in the corresponding action you could take. I've grouped them into three thematic blocks, roughly corresponding to:

 - The challenges of coming up with a specific incremental adjustment

 - The challenges of getting your stakeholder to take your concerns seriously

 - The challenges of getting another human being to change their mind
...
...they hear this as a request to change their behavior, indefinitely.

That feels like a major request, so their brain whirs up into action, quickly coming up with reasons to say "no": you barely have enough time to get through all the tickets already; it'll take forever to share all that context; that one scary engineer always glares at them when planning runs long; etc, etc.

*Solution*

Ask your stakeholder to change their behavior for a *limited period of time*, and promise to review how it's going at the end.

/"For our *next sprint*, could I ask you to, during planning, spend some time laying out the ‘Why’ behind the epics, before we get into the detailed tickets? After the planning session, we can check in, and if it turns out we ran out of time, I'll work with you to streamline grooming and pre-planning, before the next one."/

The PM in question may still find this a bit nervous-making to contemplate, but it's being presented as an *experiment*, not a *commitment*, so your odds are much better of getting a "yes."

*** Offer A Future Decision

*Problem*

Your stakeholder is human, and thus, agreeing to change their behavior /because someone asked them to/ makes them feel like they're losing control.
...
...your stakeholder, who already feels like they're struggling to keep the work on track, hears you asking them give up even more control! How are they supposed to know what is going on?! Those status check-ins are critical! They push back.

There are, subtly, two things going on here: first, the new pattern of interaction would genuinely remove some touchpoints that allowed them to exert control in the past; second, letting *you* dictate how the two of you work together places your stakeholder in a "lower status" role, which also feels like a loss of control. Their brain will immediately translate the second fear into the first, quickly coming up with lots of Perfectly Rational reasons why your idea Just Won't Work... which gives them the pleasant benefit of retaining the higher status role.
...
/"I'd like to ask for the team to do a month of heads-down exploration. At the end of the month, they'll sit down with you and do a thorough deep dive on everything they've learned, so *you* can decide if they’ve found something worth committing to. During the month, I'd like to let them go fast, without having to report back on status to you and me, so they can produce a really solid overview at the end of the month. Can we spend some time aligning on what key info you'll want to base a decision on?"/
...
That's a genuinely great way to work! I highly recommend it! But good lord, there are so many moving pieces to get right. Trying to change too much at once is a pretty much guaranteed way to trigger organ rejection.
...
...your stakeholder hears:

/"Please allow us to miss our next several delivery deadlines so that we can do something that you'll never understand, to make things theoretically better in a way you'll never be able to see."/[fn:: Aka, for you old school Far Side fans, "Blah, blah, blah, Ginger, blah, blah, blah."]

Your stakeholder is working night and day to launch a new product, in order to hit their strategic outcome of "Grow top-line revenue by 50% in the next two years." Therefore, they say, /"We don't have time to focus on anything but business priorities right now."/
...
Notice how you've *arrived at the strategic outcome*. You've connected your immediate concerns to the specific thing your stakeholder is working backwards from.

*** Tell A Story Of Growing Danger

*Problem*

You've worked out a way to connect your current frustrations to longer-term strategic outcomes, but the connections feel dry and unconvincing.

*Example*

You walk through the chain above, and say, /"... and that's why we believe we should do a library review, if we're serious about the enterprise segment."/

Your stakeholder understands and accepts the steps in your Five Whys chain. But... they've committed to the CEO to ship a version of the new product by the end of the quarter. And there are a dozen things that feel urgently on fire.

They say, /"Maybe we can talk about this, what did you call it, library review after we launch the beta. But I think we need to stay heads down for now."/

And then... they promptly /forget about this conversation/. It felt to them like "an engineering concern". It presented as kind of abstract. Unconsciously, they tagged it as "safe to ignore for now". It didn't lodge firmly into their mind.

*Solution*

Use the structure of a *story of growing danger* to render your concerns vivid, immediate and memorable to your stakeholder.

You say, /"Last week, I caught up with one of the senior sales reps. She told me that, a year ago, when she closed our first enterprise customer, they didn't ask much about security. But, since then, more and more deals in her pipeline are stalling out, because everyone's getting so worried about data breaches."/

/"She's tried buying time by promising that we'll have a SOC-2 by early next year. She's managed to close a few deals based on that promise. But now, because of the pressure to get the beta live, we're running a risk of missing our SOC-2 deadlines altogether. She's *really* worried about going back to those customers if we don't get an audit completed. She told me "there's no way on earth" the sales team will hit plan next year without a clean SOC-2."/

That's a story that follows a specific structure that is wired into the human mind. Later, we'll break down the beats of that story, and show how to apply them.
...
After you tell the above story of growing danger, your stakeholder is clearly worried. But they're still fretting over all the other priorities, and you can't seem to get into a concrete conversation about the steps to take, right now.
...
/"We've worked with the security team to create a series of overall milestones for getting to SOC-2. For the detailed work leading up to the first milestone, we've set up a burndown for you to review as we go. We want to devote a bit of time steadily each sprint, but you'll be able to see if we're on track, and how much work remains. If it looks like we're running a risk around our SOC-2 deadlines, you'll know early, and we can talk with the exec team about options."/

/"Also, sales has agreed to start tagging opportunities in the Salesforce that name the lack of a SOC-2 as a blocker. They'll be able to run reports across the pipeline to see potential impact from about the middle of the funnel down."/

Not only does the visibility help with motivation (e.g. the cost of purely focusing on the new product can now be seen in the sales pipeline), but, as importantly, you're offering them a way to see incremental progress, week over week and month over month. That converts the security work from an abstract, "blank check" investment to a steady forward march.
...
Your stakeholder is human, and thus, your request to change their behavior makes them feel defensive and therefore, resistant. This is especially true if their behavior is frustrating the people around them. But, good lord, they're being so frustrating.

*Example*

After your team shares updates and options with your CEO, they have this habit of holding forth for five minutes about all the other things the team *could* be doing. Then, once everyone is good and totally confused about priorities, the CEO briskly says "Thank you," stands up, and leaves the meeting.

If you say /"Could you please not talk about all the other things you're thinking about, after the team shares options with you?"/...

...your CEO hears it as a personal attack. If they ask /"Why?"/ you're going to be incredibly tempted to say, /"Because everyone is finding it frustrating."/ That would be totally accurate! But would also just about guarantee that your CEO will fight you tooth and nail!
...
You're asking your CEO to be an expert! But you're pointing their expertise at the very problem they're currently causing -- leaving the team totally confused after the meetings. If you keep on asking your open-ended question over and over, your CEO will gradually come up with the brilliant idea of making sure they end the meeting by clearly stating the top priorities for the team, and clearly stating the things the team *shouldn't* work on. You say "Wow, what a great idea." Your CEO looks forward to trying out "their idea" at the next review meeting.

We'll share more details on how to apply this incredibly useful technique later! Humans are fun! This technique totally works when applied to me, even if I know you're trying to use it!

*** Find Wins For Your Stakeholder By Hook Or By Crook

*Problem*

You can't figure out a way for your adjustment to immediately improve things for your stakeholder. Try as you might, you don't see a way to address your frustrations that directly benefits them.

*Example*

The head of Customer Success constantly interrupts you to check in on the status of the various troubleshooting tickets their team has submitted. You want them to instead bring all ticket questions to a weekly status/triage meeting. The resulting increase in focus time would accelerate delivery of new features that Success has been begging for. But... that will take a while.

If you directly ask the head of Success to do this, they might agree... but they might also resist, since there's no immediate benefit for them (they find it genuinely useful to get those quick updates from you). Even if they do try it out, they may perceive it as something they're doing "for you". It may feel "only fair" to them, to still ping you, if a ticket is "important". And then, before you know it, you're back in the old pattern.

*Solution*

Find some wins for you stakeholder that you *can* offer... even if they're not strictly necessary for your adjustment.

You've noticed that the head of Success /loves/ telling stories about customer problems. You think it *feels good* to them, to walk people through some specific challenge a customer is having with the product. Beyond a rational desire to get certain work prioritized, you suspect that makes them feel like they're doing "everything they can" to support "their" customers.

You add to your proposed status/triage meeting a "Customer Story Of The Week", where the head of Success will take a few minutes to tell a full story behind one specific ticket that their team has submitted. You'll bring along one engineer to triage, and the two of you will listen carefully to that story and ask questions.

Now the head of Success has something to look forward to, and the new meeting feels like it'e "for them", as much as for you.
...
...your product peer immediately *feels* stuck. What are they supposed to do instead? They will be in a place of resistance.
...
To ship a key new product this year, you want to deprioritize enterprise support, which currently consumes a lot of engineering time. But you know the VP of Sales will worry about retention rates, if you do so.

You might be tempted to sweep this under the rug, by just focusing on the positive, and avoiding open conflict. But, if you only say, /"We're proposing to strongly focus engineering time on the new product, because that's the core of our company strategy"/...
...
/"We realize that pulling engineering focus away from enterprise accounts runs a risk of frustrating some important customers. We'd like to propose that the account managers identify a small handful of really key customers, and we'll commit to maintaining full engineering support for those. But we also realize this shift will make the AMs' jobs harder this year."/

By speaking empathetically to their fears, you're inviting the VP of Sales to work with you to figure *how* to make this change work, instead of just fighting *against* it.
...
But... the VPE knows that this will be frustrating to their teams. /All/ of the teams are used to getting custom builds, and some may genuinely *need* things that your pre-configured instances don't provide. If the VPE issue this mandate, they're going to get a flurry of upset Slack messages and emails over the next few weeks, as engineers are suddently stuck as they're trying to get something live.
...
In this case, you could say, /"I know this is going to have some shaky moments early on. My team will set up and monitor a dedicated slack channel for any problems. I'm going to personally clear my calendar for the next month, so I can be as responsive as possible during the initial rollout. Also, if it's okay with you, I want to give the team leads my cell number, and encourage them to call or text me if they hit something tricky or time-sensitive. Finally, if it's okay with you, I'd like to lead a Q&A immediately after you announce this change, so I can hear about any concerns or frustrations."/
