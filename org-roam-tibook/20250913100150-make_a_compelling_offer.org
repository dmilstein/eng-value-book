...
Therefore, to equip you to work with your very own Important Person, with their very own Fun Challenges, I'm going to share a sprawling smorgasbord of *tactics*. Which I will helpfully organize by *frustrating stakeholder behaviors*.[fn:: Let's be clear: every one of these frustrating behaviors is a super common *human* behavior. Which is to say, you and I will demonstrate these exact same behaviors whenever someone asks *us* to change. But that's only because we're fundamentally nice and good people and none of our behavior is every frustrating to anyone reasonable, lalalalala I can't hear you.]
...
So if you see a specific frustrating behavior, and say, "OMG, *yes*, that's *exactly* my CEO!", but then, to your dismay, the solution seems super unclear, and you clutch your head and say, "OMG, *no*, what are you even *saying*, Dan?!?! Could you *please* write a *longer post* explaining what you're talking about, in like *more detail*?! And could you also please *illustrate* these tactics with *playful little stories?!*", then, friend, you have come to the *right frickin' place*.[fn:: If you were to also say "Dan, could you maybe *tone down* the constant use of *bold fonts*?" I'd have to say "I have *no idea* what you're *talking about*."]
