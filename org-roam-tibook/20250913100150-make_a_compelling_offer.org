...
*** Name the strategic, long-term outcome
...
Thus, to bring it more fully to life, and to equip you with a wide set of options to work with your very own Important Person, I'm going to share a broad set of *tactics* for first developing and then delivering this kind of offer. For going through various parts of the four step approach.
...
Below, I'm going to list all the tactics in summary form. In subsequent posts, I'll explore the tactics in more detail.
...
Your stakeholder is reluctant to consider a change in their behavior.
...
*Example*
Before: /"Could you please spend more time sharing context with the engineers?"/

After: /"For our next planning session, could we start by having you lay out the ‘Why’ behind the epics, before we get into the detailed tickets?"/
...
Before: /"Please let the team spend a month exploring without constantly interrupting them."/

After: /"At the end of the month, you can review progress from the team’s spike of exploration, and decide if they’ve found something worth doubling down on."/

*** Shrink Your Ask
*Problem*

Truly improving how you work together requires a complex adjustment, and you can't see a way to implement it all at once.
...
Before: /"Can the exec team set high-level strategy instead of feature delivery deadlines, the product team turn that strategy into a series of outcomes instead of project specs, and the engineers step up to collaborate around those outcomes instead of just trying to chew through tickets as fast as possible?"/

After: /"For the next few sprints, can we take the time to be sure sure the engineers understand the outcomes we’re hoping each bundle of features will enable?"/
