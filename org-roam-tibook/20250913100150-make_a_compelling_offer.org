...
You've defined a Strategic Intent that your stakeholder cares about. You have a shared long-term goal you can speak to, and an understanding of how your work contributes to that goal.

You've taken the time to develop an empathetic understanding of their key emotions. You can speak with empathy to the situation they find themselves in. You can identify frustrations that they want smoothed away. You can name things they want, that they feel like they're not getting.

You're ready to define a specific request for change, and then wrap that up in a compelling offer.
...
3. *State your own concerns*
   ...
   You'll do so directly and clearly, but in a way which doesn't trigger defensiveness
...
Be ready to spend some real time preparing  your offer. In my experience, even once you have all the pieces, there ususally isn't an immediately obvious way proceed. It takes time to come up with something crisp, clean and compellings. Talk to some friends about good patterns of work, test out your thinking with people you trust. Sleep on it, and see if any new ideas come to you the next day.

To support you in the work, I'm going to list a set of tactics, along with examples to bring them to life. For each tactic, I'll list the kind of problems it can help address.

Feel free to dip in an out of these.

You'll find more ideas in the second half of the book, in the case studies.

** Tactic: Timebox The Adjustment
...
It's *much* easier for a stakeholder to say "yes" to a request to try something that  ay feel "slightly uncomfortable" for a few weeks, than it is to agree to change their behavior indefinitely (aka, /forever/).

Once you get a commitment to try something new for a short period of time, you can then work to ensure that, at the end of that initial period, the stakeholder experiences things as going well.

Example:

Louisa is a staff engineer. One of her key responsibilities is conducting periodic architecture review sessions with teams in her domain. Unfortunately, her CTO, Dave, has developed a frustrating habit of "dropping by" those review sessions and offering half-baked ideas (Dave always /starts/ by saying "Can I ask a question?", but somehow his questions all end up being thinly veiled suggestions). This pattern is both undercutting Louisa's authority *and* sending the teams down a succession of blind alleys (he's the CTO! His suggestions seem really important!).

She could simply say, "Dave, please stop speaking up in the review sessions." Or, even "Dave, please stop coming to those sessions." But both of those feel like big asks to make, and she's worried he'll push back. Also, he does, in fact, need to be able to ask questions in order to stay on top the evolving architecture of their systems. She also knows Dave likes observing his teams at work, seeing who is stepping up, who is struggling.

She decides to frame it as: "Dave, I'd like to ask to try something out for our next two sessions. If you're okay with it, I'll ask you to *just* listen and take notes. I'll meet with you immediately after each session, to dig into any questions you have, and to get your feedback on both the team and the architecture. After the first two sessions, we can see how it's going. I think this could help with <long-term goal X>..."

That's a lot easier to ask. It positions the adjustment as a sort of "shared experiment" they're entering into together, instead of a demand that Louisa is making. It's an ask for just two sessions, not forever.

Committing to meet with him after each session is an example of the Put Yourself On the Line tactic. Asking for his feedback on the team and the achitecture is an example of Find Wins From Feelings.

** Tactic: Shrink Your Ask
** Tactic: Find Wins From Feelings
...
** Tactic: Connect Now To Later

Work Backwards With Whys
...
One way to break this down is to start by simply naming the immediate frustration you're experiencing, and then asking "Why is this a problem for the business?".
...
Sagar is getting more and more frustrated, because the sales team keeps pestering him and his team with an endless series of 'urgent' new feature requests. When a sales rep doesn't get an immediate response, they relentlessly ping Sagar to "check for status". Last month, at the company party, Sagar saw Jordy, a sales rep, striding towards him with a big grin on his face, and Sagar had an overwhelming desire to run away, out of fear that Jordy would try to browbeat him into working on Jordy's pet feature.[fn:: He was right.]
...
** Tactic: Schedule A Future Decision
...
** Tactic: Depersonalize Frustrations
