...
To prepare your request, start by *precisely* defining the incremental change you're going to ask your stakeholder to make.
...
Aka, you want to work backward from a win.
...
This is where the work you've done to dig into your stakeholder's fears, frustrations, delights and dreams pays off. That map of their emotional landscape will make it possible for you to propose an incremental improvement that will feel good to them, while also addressing your concerns.

As you dig into the details of what you're going to ask, I recommend methodically working through the following:

 1. Ensure you can speak authentically to the long-term goals for the business

    You need to be able to see how a change in behavior, right now, will help move the business towards those long-term goals. Often, your stakeholder will have either fears or dreams tied up to those long-term goals.

 2. Think about what is frustrating to your stakeholder, in the current situation.

    You want to be able to pair your ask for a change with an offer to improve something for them.

 3. Think about what your stakeholder *likes* about the current situation

    You'll want to either directly own that you're asking them to give something up, or, often better, offer them something new that gives them the same underlying benefit
...
In thinking back over the last month of development, she realizes that the team has put together most of the bits of one specific activity: the Virtual Dunk Tank (for which a team leader holds a bowl of water over their own head, and, once enough people on their team have hit the virtual targets on each of their own screen, a buzzer sounds and the leader has to dump the water on themselves).

If the team could just have a couple of weeks without distractions, she'll be they could get that into demo-able state. She can almost see it, already.
...
But if Quin can get Marco to try it, this new way of working coudl generate wins across all three fronts:
...
Quin has used all that she learned about Marco's *feelings* to develop something which has the potential to work for Marco, for her and for the business as a whole.

She's almost ready to make her request of Marco.

But there's one final step, to make it as easy as possible for him to agree to her proposal. She's going to add something to speak to an underlying fear that just about all stakeholders share.
...
We're going to want to assume that your stakeholder has some fear of *losing control*.
