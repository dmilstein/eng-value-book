...
These are fair points this theoretical version of  you is making.

I have promised you a step-by-step game plan for gradually drawing your Important Person into an ongoing process of collaborative problem-solving. I have insisted on steadily making small improvements, building trust and rapport as you go. I have claimed that each such small improvement will involve the following steps:
...
Furthermore, Alistair has managed to build a genuinely empathetic understanding of the situation that Max finds himself in: the recently-hired PM's don't fully understand the existing ProClaims product, which is making it very, very had for Max to delegate decisions.
...
Alistair now has to prepare a proposal for a *specific incremental adjustment*.

In later chapters, we'll share a wealth of tactics for designing effective incremental adjustments. The core idea is to come up with a way to concrete change in how you work together, which:
...
We'll see these as a series of (increasingly oddball!) "mentors", but they also represent the voices in our own heads. When approaching someone with authority, we all have parts of us which are worried about taking too much time, or afraid to directly state our own concerns, or insecure about the ideas we're going to propose.
...
Since they had their brief moment of connection yesterday, Max has:

 - Received seventeen urgent, time-sensitive Slack messages
 ...
 - Cancelled three one-on-one meetings with his direct reports
...
Now Alistair gets to the chage that he most desperately wants. "During those sprints, we'll give the team license to ship to production without getting formal approval from you. We'll do an extra thorough end-of-sprint demo, and, afterward, you, me and Asha can meet and set direction for the team, based on what you saw."

Alistair sits back, proud of his proposal. It addresses the bizarre anti-pattern they've somehow drifted into, of every team waiting to ship even small changes until Max can review them.

What is happening for Max, now?

Max is very confused. Is this is meeting about training the PM's? Or about deploy processes? Or, like, what?

Where does Alistair think Max is going to find this magical extra hour to spend on "deep dives"? And why on earth is Alistair trying to force Max to give up on reviewing changes before they go live? Just last month, a team almost shipped an obviously stupid UI change to production, thank god Max saw it during review and demanded an immediate revert. If that had gotten through to customers, there would have been hell to pay.

# , which is not something he enjoys.

Max realizes that Alistair is sitting across the table, waiting expectantly. "That's not going to work," announces Max, frowning.[fn:: And, bang, we're on track for Max entering into the meeting by announcing someone is wrong!]

Let us draw the curtain of charity across the rest of this day.[fn:: What, my addiction to footnotes hasn't made it clear I had a formative experience of reading David Foster Wallace in my youth? If you're not sure what I'm talking about, run don't walk to read the title essay in A Supposedly Fun Thing I'll Never Do Again. This book (and your tech career) will be waiting for you when you get back! Say hi to Tibor for me!] Having gotten off on so very much the wrong foot, this entire meeting is going to go completely down in flames.

As we watch the conflagration begin, let us note that Alistair actually proposed a quite good initial adjustment.

It represents a bounded commitment of time from Max (two sprints); it asked Max to do something just a bit uncomfortable (stop personally gatekeeping every change to production); it gave him a useful new form of control in return (meeting with Asha and Alistair after each demo to guide the team); it made things just a bit better for *Alistair* (he'd have two sprints without constant Max oversight); it set them both up for the long-term goals (by investing in Asha leveling up, so they can eventually get to a faster flow state).

But, because Alistair just dove in, Max was defensive and reactive.

Alistair didn't connect this conversation to a long-term strategic outcome, nor did he demonstate any understanding of Max's concerns. Thus, Max didn't shift gears at all from his default state of day-to-day anxiety-driven tactical reactiveness.
...
First off, Max is still totally unclear what this meeting is about. But it's... not unpleasant to hear Alistair outline AccuraClaim's overall goals. Apparently he, Max, communicated those goals really clearly?[fn:: Alistair figured out the long-term goals by buying lunch for the VP of Product, and letting her complain about a particular director of customer success who is widely understood to be her nemesis.] Good job, Past Max! He nods, "Go on."
...
He sits back. "Is that a solid way to understand what we're doing? AccuraClaim's most important goals across the ClaimsPro platform, and how my team's work supports those goals?"
...
Alistair is visited with a clear vision of him acting in exactly that way.
...
Alistairs pauses and breathes. Max nods, once, slowly. There's a trace of tension in his jaw. But Alistair can see that he's heard him.

"Okay, here's my proposal," he says, and lays launches into his ideas. When he gets to the "slightly uncomfortable" ask, he slows down and force himself to make it really clear.
...
"But, some changes can cause real problems."
...
Because Alistair was listening so carefully, one specific word stood out to him. "Max, I think you said that 'some' changes can cause problems, is that right? 'Some' changes might piss off big insurers?"

"Yeah, that's right."

"Are there other, like, whole classes of changes you don't feel like you need to worry about?"

Max considers. "Yeah, I guess so."

"Do you think we might be able to look ahead, at the start of the sprint, and figure out what planned work will actually need your review? So we can free the team up to move fast on /most/ of what they're doing, but make sure you can still carefully review anything risky?"
...
** How Can Stakeholders Resist Change? Let Me Count The Ways

/A Catalog of Both Challenges And Tactics For The Making Of Compelling Offers/
...
Therefore, to equip you to work with your very own Important Person, with their very own Fun Challenges, and their very own Creative Ways To Resist Change, I'm going to share a sprawling smorgasbord of *tactics*. Which I will helpfully organize by *frustrating stakeholder behaviors*.[fn:: Let's be clear: every one of these frustrating behaviors is a super common human behavior. Which is to say, you and I will demonstrate these exact same behaviors if someone were to have the temerity to ask *us* to change. But that's only because we're fundamentally nice and good people and none of our behavior is every frustrating to anyone, like, /reasonable/, lalalalala I can't hear you.]

Stroll through the aisles! See if any particular stakeholder behavior looks familiar! If so, pull a tactic off the shelf and try it out.

I'm going to list the full set in summary form, first. Then, in later posts, I'll explore each in more detail.

So if you see a specific frustrating behavior, and say, "OMG, *yes*, that's *exactly* my CEO!", but then, to your dismay, the solution seems cryptically unclear, and you clutch your head and say, "OMG, *no*, what are you even *saying*, Dan?!?! Could you *please* write a *longer post* explaining what you're talking about, in like *more detail*?! And could you also please *illustrate* these tactics with *playful little stories?!*", then, friend, you have come to the *right frickin' place* (by which I mean, of course, come back to this place, um, later).[fn:: If you were to also say "Dan, could you maybe *tone down* the constant use of *bold fonts*?" I'd have to say "I have *no idea* what you're *talking about*."]
...
** TODO Maybe: save the fear of bugs to the collab stage
