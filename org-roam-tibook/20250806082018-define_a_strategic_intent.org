...
** A Story: Maria Makes A Compelling Offer
...
On the one hand, this statement has the benefit of being *completely true*. On the other hands, odds are very good that Geoff has, [like most executives] during the course of his career, acquired the skill of /creatively mis-hearing/ requests to change his behavior.[fn:: I'm now 100% imagining this skill being taught to promising young leaders, before they're allowed into the hallowed halls of the Senior Leadership Team. Along with, /How To Demand Progress Against Obviously Conflicting Goals/, /How To Blame A Team For Your Own Failings: A Survey Course/, and /How To Join Meetings Late And Leave Them Early To Demonstrate How Important You Are/. Are these a series of lectures? Small group discussion sections? What HBS case studies are involved? I have so many ideas.]

# Maybe, Like most executives, Geoff has acquired the skill of creatively mishearing requests to change his behavior.

He thus manages to hear this as Maria asking for something *for the product team*---not for the business at large. Geoff will use this skill of creative mis-hearing /totally unconsciously/. When our brains come up with ideas in our own self-interest, they work hard to pretend that they're not doing so. We call this "rationalizing", and usually we do it unconsciously.[fn:: Why? Evolution has selected for our being able to truly believe in our own unselfishness, in order to effectively persuade others that we are unselfish. So being able to act selfishly, but believe we're not... has got thousands of years of natural selection working for it.]

# Evolution has worked very hard, for thousands of years, to ensure we can internal building narratives about our own fundamental goodness, no matter what we do.

I mean, consider this whole situation from Geoff's perspective:

He has plan and quota to hit! He's not asking for much, just attention for a few key problems here and there! Maria clearly doesn't understand how hard it is to keep customers happy! Are they supposed to just let those customers churn?! He's being completely and totally /reasonable/.

# [fn:: Like literally all humans, Geoff also has the the skill of creatively rationalizing behavior in his own self-interest. And, yes, by all humans, I totally mean you and me. I'm super good at this one. Maybe a bit worryingly so, to be honest.]

# and will continue on his merry, relentlessly distracting way.

If we did beneath the specific concerns and objections, what's happening at a deeper level is simply:

*Geoff is worried that Maria is going to prevent him from succeeding in his own job.*

Where success is, ultimately, being able to keep working towards some long-term outcome he cares intensely about.

In such a situation, Geoff's mind will eagerly come up with all sorts of excellent reasons why he should push back.

But what if instead, Maria *knew* the outcome that Geoff cared most intensely about?
...
How does Geoff define success as his job? What is keeping him up at night?

Geoff and Maria's company is facing a critical challenge: for years, they've been successfully selling to small and medium-sized businesses (aka, the SMB segment). That segment is, unfortunately, pretty much completely tapped out. Geoff's sales team is running out of SMB leads. The company will only be able to grow revenue if they can somehow start selling to significantly larger business, aka, the fabled enterprise segment.
...
This is, let us say, a happy dream to imagine... but is not something they're anywhere close to achieving at the moment.

Geoff, being *the VP of Sales*, feels hugely under the gun for this outcome. He's been building up an enterprise sales team, he's endlessly reviewing recordings of sales demos with any opportunities even vageuly resembling enterprise, he's personally conducted a half dozen interviews with enterprise buyers. None of it seems to be working yet.
...
/"Could you help find a way to commit more time to developing those key enterprise features? Even if it means allowing some current customers to grow frustrated. One option: if you can identify current customers who have similar problems to your enterprise prospects, we can focus our limited support time on them, to maximize learning while also keeping those customers happy."/

Geoff will hear this request very, very differently.

The struggle to build an enterprise sales pipeline is keeping him up at night. The lack of certain table stakes enterprise-specific features is a huge part of that. Given that, he will hear this as Maria *understanding his pain*. He'll be enormously more ready to listen.

She's also proposed an adjustment that could work for both of them---limiting the support time, but focusing it on a small set of customers that *Geoff* identifies.

He raises a few concerns Maria didn't know about, and then the two of them dive into the mechanics of how to limit support time, while still serving the most important customers. As part of that, they dig into the details of the features Geoff keeps hearing about from enterprise prospects. The two of them discover a creative option: if the product team really focuses, they could enable Geoff's sales leaders to starting *demoing* some key features very soon... even though fully implementing those features will take a long time. That will unblock a lot of currently stalled sales conversations, which will let Geoff hit his near-term milestones around enterprise sales pipeline.

At the next prioritization sync, Geoff stands up and tells the rest of exec team to clear the decks for Maria's team. She sits and listens, slightly dizzy with surprise.

# He is very worried that the lack of sophisticated identity management and a few key third party integrations are killing their enterprise conversations before they even get started.

Note: in the above pitch, Maria used several tactics that we'll explore in How To Make A Compelling Offer. Specifically:
 ...
 - Invite Your Stakeholder To Solve Your Problems
   ...
   /"Could you help find a way to commit more time to developing those key enterprise features?"/
...
As above, being able to speak to a strategic outcome that your stakeholder cares intensely about is *insanely valuable*. I'll name three reasons:

 - *It creates the flexibility to identify a new way to work together*

   Developing software is an incredibly complex effort. To succeed, you need room to maneuver. You need a nuanced understanding of long-term goals.

   That nuanced understanding allowed Maria to come up with a new idea: focusing her team's support time on the "enterprise-like" current customers.

 - *It enables you to position your proposed change as a necessary step to achieve the outcome*

   This helps enormously with motivation, because of how much your stakeholder cares about this outcome.

   Maria was able to say, authentically, that they must change how they work together if her team is going to successfully deliver the new enterprise features that Geoff desperately wants.

 - *It enables you to demonstrate a personal commitment to achieving the outcome*
...
I can tell by how you're nodding along, that you're totally convinced! But I can also tell that you are, rightfully, a bit worried. Because you may not have that nuanced understanding of your own stakeholder's long-term goals.

For the simple reason that *your stakeholder doesn't talk about the outcomes they care most intensely about*.

# Of course, all this is only possible because Maria has somehow divined the strategic outcome that Geoff cares most intensely about.
...
Why on earth not, you might well be asking?[fn:: Unless you've worked in software for a long time? In which case you might be saying, "/sigh/"]

First off, let's just talk about the mechanics.

Your stakeholder has some long-term business outcome they're working backwards from. They then spend time and effort *converting* that outcome into a series of tasks, projects and milestones.

The key problem is when, having sone so, they only talk in detail about the tasks, projects and milestones, and *don't* talk in detail about the long-term business outcome those are supposed to enable.
...
Some stakeholders consider this narrowness, this limitation on what they share, a *virtue*---because it force you to "focus on what matters". They don't want you to be "distracted" by all this irrelevant information.

In this case, I usually find that asking a few questions, and then Echoing Back, and asking more questions, is extremely effective. You're not challenging your stakeholder by doing so, you're allowing them to be an expert. You're celebrating their own nuanced understanding of the challenges facing your business. And then, once you have that more nuanced understanding, you can make a compelling proposal to focus on *new* things that matter.
...
*** What You Don't Know You Actually Do Know Because I Totally Told You
