...
Remember Maria, the PM from our opening chapter, who was struggling with her VP of Sales, Geoff? Because the Geoffster kept on undercutting her prioritization to try to force work for his pet customers? And thus her product strategy was dying the slow death of a thousand cuts?

If Maria *doesn't* understand the strategic outcome that Geoff cares most intensely about, all she can say is something like:

/"We're never going to be able to deliver on our product strategy if we can't focus."/

Geoff will, mostly likely, hear this as something *for the product team*, and will continue on his merry, relentlessly distracting way. He's got plan and quota to hit right now! Maria clearly doesn't understand how hard it is to keep customers happy! He's not asking for much, just attention for a few key problems here and there! Are they supposed to just let those customers churn?

Humans are very, very good at rationalizing behavior in their own self-interest. If Geoff hears Maria pushing for something which will impede him from hitting his own goals, his mind will come up with all sorts of reasons why he should push back.

But what if Maria knew the goal Geoff cared most intensely about?

As it turns out, Maria's company is facing a critical challenge: for years, they've been stuck in the Small Medium-Sized Business (SMB) niche. That niche is, unfortunately, pretty much tapped out. They will only be able to grow revenue if they can somehow break into the enterprise segment.
...
This is a, let us call it, happy dream to imagine... but is not something they're anywhere close to achieving at the moment. Geoff, being *the VP of Sales*, feels hugely under the gun for this outcome. He's been building up an enterprise sales team, he's endlessly reviewing recordings of sales demos with any opportunities even vageuly resembling enterprise. None of it seems to be working yet.

What could Maria do with this knowledge? Well, she could say something like:
...
/"I want to propose we find a way to commit more time to developing enterprise features, even if that means allowing some current customers to grow somewhat frustrated. One option: if you can identify current customers who have similar problems to your enterprise prospects, we can focus our support time on them, to maximize learning while also keeping those customers happy."/

If, in fact, building an enterprise pipeline is keeping Geoff up at night, he will hear this as Maria *understanding his pain*. He'll be enormously more ready to listen.
...
She's been able propos a creative option that might work for both of them.
...
Being able to speak to a strategic outcome that your stakeholder cares intensely about is *insanely valuable*, for (at least!) three reasons:
 ...
 - *It creates the flexibility to identify a new way to work together*
   ...
   The inherent [unavoidable, profound] complexity of developing software means you need room to maneuver. You *can't* simply "do what your told".
 ...
 - *It enables you to position your proposed change as a necessary step to achieve the outcome*
   ...
   This helps enormously with motivation. Achieving this outcome is at the core of how your stakeholder understands success in their own job.
...
Here's an incredibly brief summary of a good outcome:

 - A good strategic outcome is one that allows teams to quickly make good decisions
...
Unfortunately, in my experience, the vast majority of companies building software do not set strategy in a way that allows for rapid local decision-making.
...
My theory is simple: developing software is weird as heck.
...
But the special weirdness of software around both the quantity and the scope of "within project" decision-making is not shared by most business functions.
...
The reason this is such a common form of conflict with The Rest Of The Business is that the uncertainty around developing software is just so much greater than around most business activities. It's a form of research and development as much as executional operation.
...
# XXX Allowing the team to make decisions is scary
...
Stakeholders often take such a business outcome and then *convert* it into a series of specific tasks and projects. Having done so, they proceed to only ever talk about those tasks and projects.
...
To be fair, this may be a perfectly reasonable way to run business efforts *outside of software development*.

, and then only ever talk to a team about one particular task or project.
