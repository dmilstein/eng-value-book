...
* Scraps/Thoughts
Maybe, use this chapter to, like, *define* a strategy, and explain that, if they don't know one, they should guess. But they ideally want to state in terms the stakeholder uses. And we'll learn more about that in the next chapter.
