...
On the one hand, this statement has the benefit of being *completely true*. On the other, odds are very good that Geoff, [like most executives] during the course of his career, has acquired the skill of creatively mis-hearing requests to change his behavior.[fn:: Okay, I'm now 100% imagining this skill being taught to promising young leaders, before they're allowed into the hallowed halls of the Senior Leadership Team. Along with, what, /How To Demand Progress Against Obviously Conflicting Goals With a Straight Face/, /How To Blame A Team For Your Own Failings: A Survey/, /How To Stay Blind To Your Own Limitations/, /The Theory and Practice Of Self-Deception/. Is it a lecture? A small group discussion section? I have so many ideas.]

# Maybe, Like most executives, Geoff has acquired the skill of creatively mishearing requests to change his behavior.

He thus hears Maria asking for something *for the product team*---not for the business at large.[fn:: Note that Geoff uses this skill of creative mis-hearing /totally unconsciously/. For evolution reasons, our internal narratives are all about plausible deniability.]

Also: Geoff has plan and quota to hit! He's not asking for much, just attention for a few key problems here and there! Maria clearly doesn't understand how hard it is to keep customers happy! Are they supposed to just let those customers churn?! He's being completely and totally /reasonable/.

Like literally all humans, Geoff also has the the skill of creatively rationalizing behavior that his mind perceives as in his own self-interest.[fn:: Yes, by all humans, I totally mean you and me. I'm super good at this one. Maybe a bit worryingly so, to be honest.]

# and will continue on his merry, relentlessly distracting way.

At some deep level, what is happening is:

 - Geoff hears Maria pushing for something which will impede him from achieving an outcome he cares intensely about

In such a situation, his mind will eagerly come up with all sorts of reasons why he should push back. He'll be in a state of resistance.

But what if instead, Maria *knows* the outcome that Geoff cared most intensely about? What if she can speak to it in the very terms Geoff thinks about it?

Let's see how that plays out.

Maria's company is facing a critical challenge: for years, they've been successfully selling into small and medium-sized businesses (aka, the SMB segment). That segment is, unfortunately, pretty much completely tapped out. They will only be able to grow revenue if they can somehow start selling to significantly larger business, aka, the fabled enterprise segment.

At the last board meeting, The CEO stood up and promised that, within eighteen months, a full 30% of annual recurring revenue would come from enterprise customers.

This is, let us say, a happy dream to imagine... but is not something they're anywhere close to achieving at the moment.

Geoff, being *the VP of Sales*, feels hugely under the gun for this outcome. He's been building up an enterprise sales team, he's endlessly reviewing recordings of sales demos with any opportunities even vageuly resembling enterprise. None of it seems to be working yet. In fact, some of the customers he's trying to cadge favors for are their largest existing customers, who, if you squint at just a bit, could arguably be enterprise deals.

What could Maria do with this knowledge? She could approach Geoff with an entirely different sounding request, that he will *hear* totally differently:
...
/"I want to propose we find a way to commit more time to developing enterprise features as soon as possible, even if that means allowing some current customers to grow somewhat frustrated. One option: if you can identify current customers who have similar problems to your enterprise prospects, we can focus our limited support time on them, to maximize learning while also keeping those customers happy."/

This is a radically different request.

The struggle to build an enterprise pipeline is keeping Geoff up at night. The lack of certain "table stakes" enterprise-specific features is a huge part of that.[fn:: Ugh, I can't even write that sentence without carping briefly. I dunno, 90% of the time someone has insisted that a set of features are "table stakes", what they're actually saying is "I personally like these features a lot." It's one of those ways to state an opinion as if it's an incontrovertible fact. In such situations I *don't* recommend getting into a debate about "what customers really need". In stead, I recommend just nodding and smiling, and then directing your team to build a coherent product which doesn't have the "table stakes" features. You can then offer that as a thing which could be sold, while you go about adding the table stakes features.] He will hear this as Maria *understanding his pain*. He'll be enormously more ready to listen. She's also proposed something specific, that could work for both of them---limiting the support time, but focusing it on a small set of customers that *Geoff* identifies.
...
She's used several tactics that we'll see later, in How To Make A Compelling Offer: Tell A Story Of Growing Danger; Invite Your Stakeholder To Solve Your Problems; Address Fears Directly; Keep 'Em Busy.
