...
The struggle to build an enterprise pipeline is keeping him up at night. The lack of certain "table stakes" enterprise-specific features is a huge part of that.[fn:: Ugh, I can't even write that sentence without carping briefly. I dunno, 90% of the time someone has insisted that a set of features are "table stakes", what they're actually saying is "I personally like these features a lot." It's one of those ways to state an opinion as if it's an incontrovertible fact. In such situations I *don't* recommend getting into a debate about "what customers really need". Instead, I recommend just nodding and smiling, and then directing your team to build a coherent product which doesn't have the "table stakes" features. You can then offer that as a thing which could be sold, while you go about adding the table stakes features.] He will hear this as Maria *understanding his pain*. He'll be enormously more ready to listen. She's also proposed an adjustment that could work for both of them---limiting the support time, but focusing it on a small set of customers that *Geoff* identifies.

He raises a few concerns Maria didn't know about, and then the two of them dive into the mechanics of how to limit support time, while still serving the most important customers. As part of that, they end up digging into what Geoff considers the most hotly-desired enterprise features. The two of them come up with a creative option: if the product team really focuses, Geoff sales leaders could starting *demoing* some key features quite soon (even though buiding them will take a long time). That will unblock a lot of currently stalled sales conversations, which will let Geoff hit his near-term milestones.

At the next prioritization sync, Geoff stands up and tells the rest of the execs to clear the decks for Maria's team. She sits and listens, slightly dizzy with surprise.
...
Being able to speak to a strategic outcome that your stakeholder cares intensely about is *insanely valuable*, for (at least!) three reasons:
 ...
 - *It creates the flexibility to identify a new way to work together*
   ...
   The inherent complexity of developing software means you need room to maneuver. You *can't* simply "do what your told".

   Understanding your stakeholder's long-term goals allows you to come up with a proposal which will genuinely help them, while also addressing your own deepest concerns.

   Maria did this by proposing that her team focus their support time on the current customers whose needs overlap with the enterprise segment.
 ...
 - *It enables you to demonstrate a personal commitment to achieving the outcome*
   ...
   By showing her nuanced understanding of the pressures Geoff is under, Maria is offering to join him in his biggest struggle.


# Of course, as we said earlier, stakeholders have a weirdly common habit of simply not telling you what their strategic goals are. We'll dig into why that's often true, below.

# But, first, let's dig into what an effective statement of strategy even *is*.
...
# Maybe say 12-18 months out, maybe that's what your part is
...
Stakeholders take a strategic business outcome and *convert* it into a series of specific tasks and projects. That is, often, literally what they think their job *is*. Then, having done so, they proceed to only ever talk about those tasks and projects.

They may even consider this narrowness, this limitation on what they share, a *virtue*---because it forces their teams to "focus on what matters".

Unfortunately, some stakeholders, being human, derive some of their sense of status or self-worth from being the only one who truly understands the strategic goals. Such stakeholders can thus be /resistant/ to openly sharing strategic goals. Which, sigh. We'll share tactics for helping such stakeholders open up in later in this chapter.

At other times this is, essentially, an accident. The long-term strategic outcome feels so blindingly obvious to your stakeholder, they /forget/ they need to share it clearly and repeatedly. In fact, they may feel like they already *are* sharing it, over and over. When they say, "You absolutely need to hit your delivery deadlines for Q3," what they hear *in their own head* is, "Or else we won't be able to see if the new features improves retention rates."[fn:: That stakeholder is angrily surprised when they discover that, in order to hit the Q3 deadlines, the team cut corners, broke a key part of the product, and caused a raft of customers to churn. "But I told you how critical retention is!" the stakeholder may even say/yell. "It's literally all I ever talked about!" This statement is both completely true and completely untrue at the exact same time! Again, humans are fun.]

Aligning with your stakeholder on a strategic outcome enables you to position your request for change as a necessary step in eventually achieving their long-term goal. It gives you a great deal of flexibility to come up with new ways to work together, that allow you to reach that long-term goal. Also, importantly, it enables you to demonstrate an authentic personal commitment to achieving that goal. This allows your stakeholder to start to see you as a *partner* in facing their most important challenges.
...
As a part of this, you'll also identify how your team can, if things go well, play a role in achieving that outcome.
