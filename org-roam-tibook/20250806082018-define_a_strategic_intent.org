...
As we said earlier, being able to speak to a strategic outcome that your stakeholder cares intensely about is *insanely valuable*, for (at least!) three reasons:

 - *It creates the /flexibility/ to identify a new way to work together*

   The [inherent, unavoidable, profound] complexity of developing software means you need *room to maneuver*. You *can't* simply "do what your told". Understanding what your stakeholder is working backwards from lets you come up with new ideas which will genuinely help them get there... while also addressing your own deepest concerns.

 - *It enables you to position your proposed change as a /necessary step/ to achieve the outcome*

   This helps enormously with motivation, since that outcome is how your stakeholder understands success in their own job.

 - *It enables you to demonstrate a /personal commitment/ to achieving the outcome*

   Because your stakeholder is a human being, and not a robot, it will mean a lot to them to see that you understand, care about, and are deeply committted to achieving that outcome yourself. It will enable them to see you as a potential *partner*.
...
If she *doesn't* understand the strategic outcome that Geoff cares most intensely about, all she can say is something like:

/"We're never going to be able to deliver on our product strategy if we can't focus more."/

Geoff will hear this as something *for the product team*, and will continue on his merry, relentlessly distracting way. He's got plan and quota to hit right now! The product team doesn't understand how hard it is to keep customers happy! He's not asking for much, just attention for a few key problems here and there! Are they supposed to just let those customers churn?

Yeah, humans are super good at rationalizing their own non-awesome behavior.

But what if Maria knows his beloved strategic outcome? Maria's company is facing a critical challenge: for years, they've been stuck in a Small Medium-Sized Business (SMB) niche, and will only be able to significantly grow revenue if they can somehow break into the Enterprise segment. The CEO recently promised the board that, within eighteen months, enterprise customers will be 20% of Annual Recurring Revenue. This is a, let us call it, happy dream to imagine, but is not something they're anywhere close to achieving at the moment. Geoff, being *the VP of Sales*, feels hugely under the gun for this outcome. He's been building up an enterprise sales team, he's endlessly reviewing recordings of sales demos with any opportunities even vageuly resembling enterprise.

Imagine instead if Maria says:

/"I know how important it is for us to break into the Enterprise. And I know hard the sales team has been working on that. But I'm worried that the product team hasn't been supplying you with enough compelling features, to make those deals even possible. And since those deals take so long to close, I'm really worried that, every month we don't have something new, your team is in a worse and worse position. I want to propose we find a way to commit more time to focusing on developing our key enterprise features, even if that means allowing some current customers to grow somewhat frustrated. Unless of course, those current customer fall into the Enterprise segment, in which case we want to learn as much as possible by giving them excellent support."/

# current customers who have needs that overlap with what we're building for the enterpris.

Geoff will hear that as *understanding his pain*. He'll be enormously more ready to listen. She's also been able to use her flexibility to come up with a creative option --
