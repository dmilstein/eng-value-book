...
At heart, both the engineers and the stakeholders want to create value for the business.

They just have different information and beliefs about how best to do so.

Many engineers try to resolve this gap by *explaining* the potential value: "You see, when code is badly coupled, a change in one place can impact many other places, which is a drag on development."

Although there's a good instinct in this -- bring the stakeholders into a shared understanding with the engineers about what is valuable -- it has one crucial flaw:

It requires the stakeholders to take the entire statement of value purely on faith.

There is nothing they can see *now*, that shows them things are "bad".

And there will be nothing they can see, after the investment, that shows them things have gotten "better".

It's hardly surprising that the stakeholders, confronted with such a choice, feel like they are "giving something up", and "deserve something in return".

A better approach is to, instead, find a creative way to *build visibility* into the potential value.

You want a form of visibility that the engineers and their stakeholders can look at, *together* -- both when deciding what work to prioritize, and after an investment, to see if things have improved.

Having that shared visibility can be an absolute game changer.

Stakeholders, well, like to make decisions about what's best for the business. That's actually their job. By committing to creating visibility, you're allowing them to make good decisions.

With a sufficently deep understanding of how engineers create value for a business it's just about *always* possible to build visibility into potential value. This will be a major theme of this book.

But, for a few examples to bring it to life:
...
That took her about 10 minutes to do and socialize, and the engineers were plenty motivated to track their times (and had plenty of time to do so, while waiting for the tests to finally pass).

After a few short weeks, that initial chunk of visibility made it pretty easy to convince the product team to carve out a week for that same engineer to instrument a few stages of the deploy process, so we could actually understand where time was being spent.
...
As this story makes clear, the very best way to run tech investments is to do them *iteratively*:

 1- Spend a *small* amount of time to build *some* visibility

 2- Share that increment of visibility with your stakeholders

 3- Together, prioritize a small investment to either visibly improve *or* to build a bit more visibility
