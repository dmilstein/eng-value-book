...
If you've been following along in the steps in the game plan, you may feel ready to go. You've identified the overall outcome your stakeholder is working towards, you've named a core challenge, and you understand how your team will help overcome that challenge.

This does, in fact, put you in an *excellent* place to productively challenge your stakeholder to make a change of some kind.

But, before you do so, there is one more step:

Your stakeholder is a human being. Their behavior is not driven merely by a rational plan. We are none of us robots.
...
This is true even if you work with a CEO whose only outward expression of emotion is a series of variations on the tightly clenched jaw.

It's true even if you and your coworkers engage in serious debates about whether or not your ice cold Head of Engineering even *has* feelings.

Understanding emotions doesn't mean gathering in a drum circle and getting in touch with our inner child. All humans, in whatever positions of power they may find themselves, have things they deeply want, and things they are deeply afraid of. Your stakeholder's current behavior patterns are driven by some combination of what they want and what they're afraid of.
...
** A Story: The Context In Which Alistair Is Stuck
...
He's asked questions far and wide, and studiously echoed back and summarized what he's heard. Gradually, he's built up a picture of where AccuraClaim is today and where it's trying to get to. He's spent some time honing what he has learned.

** AccuraClaim's Much-Desired Strategic Outcome

AccuraClaim has, over the last several years, built up a robustly defensible business by taking over a bunch of gritty claims processing work for auto insurance companies.

# They have customers ranging from modest to extremely large.

Unfortunately, AccuraClaim's marketing team has started to struggle to find new customers in the car insurance vertical. Growth is starting to slow.
...
They ultimately decided to make a bet that they can solve more claim-related problems for their existing customer segment, and thus capture more revenue from each auto insurance company they sell to. They've set a specific goal to, over the next two years, increase their average billing rate from $1.10/claim to $1.50/claim.

** The Core Challenge: Data, Why Did It Have To Be Data?

# XXX who wrote the pricing roadmap.

To do this, they will need to develop new product tiers and new product offerings.[fn:: If you work at a B2B SaaS business like AccurClaim, I simply could not recommend more highly The Pricing Roadmap, by  . It's an incredibly good, actionable plan for pulling together the work of product, marketing & sales.]
...
** The Role of Alistair's Team: Make It Exactly The Same, But Also Totally Different
...
** Some Feelings The Frustrating Boss Is Feeling
...
** An Emotionally Successful Pitch For Change
...
** TODO Maybe, insert, Alistair tries to advocate, gets shut down
...
I think, no.
** TODO Spike: work in story from substack, adjust to fit Alistair and Max
** TODO Review the four emotions post from Substack
** TODO Wedge parts of it into this doc
** TODO Re-read what I have
