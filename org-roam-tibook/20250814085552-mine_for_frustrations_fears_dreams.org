...
He can tell Max is slightly surprised that Alistair is offering this kind of high-level strategic summary. But he doesn't seem irritated. If anything, hes seems curious? Max nods. "Go on."

"We're trying to launch the new claim review workflow by early next year. The new summary reports will give us teeth for a premium tier. Also, once we get the underlying data cleaned up, Eduardo's team can build the fraud detection product, to sell as an add-on. Having both of those should allow the sales team to make real headway against the per-claim average price increase." He makes himself pause again. "Is that a solid way to understand what we're doing? The most important goals for my team?"

Max has a slightly bemused look. Alistair would guess that he's hearing a more clear articulation of the "Why" behind the work then he's used to. "That's all... really good, Al," he says[fn:: Alistair kind of hates being called Al]. "Really good."

And then, heady with this moment of praise, Alistair makes his crucial mistake.
...
"What?" says Alistair, surprised by this sudden interrogation.

"You said that people are waiting on decisions from me. What decisions, exactly?"

The tight, angry tension in the air makes Alistair feel suddenly unable to think. "Um, about the data model. And the interface."

"I see," says Max, coldly. He looks down at this watch again, then stands up.

# "I would like nothing better than to delegate," he says, icily, "but no one has stepped up. No one has shown *ownership*. You're asking for me to delegate? To who? Every time I've taken my eye of the ball, things have gotten screwed up."

"We're at a critical moment. I am always available. I work incredibly hard to keep things moving. In fact, I'll have to ask you to go right now, because Jeanine is waiting on me." He gestures towards his laptop, "Thank you for bringing this to my attention," he says with a frown.

A host of angry, defensive responses flood Alistair's mind. His fight or flight system is kicking in so hard, he can barely marshal his thoughts. He somehow fixates on the tight, tense line of Max's lips. He stands up. "Okay. I... see." With that, he steps away from the table.

"Thank you," says Max again, meaninglessly, and hunches down over his laptop as Alistair stumbles out of the room.
...
Why is Max demonstrating this *obviously* problematic behavior? Right up front I'm going to say up front that we're not allowed to answer:
...
From the outside, Max's behavior seems not only unreasonable, but also *self-defeating*. We perceive that Max is actually preventing himself from achieving his long-term goals, by setting up a tentative and slow-moving team.
...
We wave our magic wand, and poof! The first thing we immediately see is that Max is struggling with an intense, somewhat overwhelming feeling of *fear*. He attempts to hide that as best he can, but it dominates his inner life.
...
Let's deploy our magic power once again. We wave our a magic wand and understand what in their overall situation is leading to this behavior:
...
Unfortunately, he is reaching for the only tool they has in his existing kit: direct, final-say oversight over every single decisionn. Worse, in the past, exerting that kind of fine-grained oversight allowed him to heroically save at-risk projects. It is how he established control and prevented failure, and *eventually got promoted*.
...
Given all of the above, Max's behavior is, well, a lot easier to understand.

To be clear: his behavior is *still* extremely problematic.
...
* Todos
** TODO Open w/ review of how to make offer
** TODO Maybe: fully insert text from opening story
Instead of "Remember?"
** TODO Insert Alistair tries to advocate, gets shut down
...
** TODO Adjust the problem to get to customers
