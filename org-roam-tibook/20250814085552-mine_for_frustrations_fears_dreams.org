...
He's asked questions far and wide, and studiously echoed back and summarized what he's heard. Gradually, he's built up a picture of where AccuraClaim is today and where it's trying to get to.
...
His team is trying to deliver a total overhaul of the claims review workflows. Under the hood, this will require breaking a bunch of key data out of EZClaims{Extra,Extra2}, and placing it into new, clean SQL tables (with sane names and the occasional use of a foreign key).

On the product and marketing side, some of the new reports his team is building will form the basis for a new, premium product tier. Factoring out the underlying data will also allow other teams to create entirely new products to integrate AccurClaim's platform more deeply into the operations of their customers.

Or, that's all the plan.

Alistair also learns that things are not going great, big picture.

# exactly according to that plan

Changing the core data model of a product used to process hundreds of thousands of claims a day has turned out to be fraught with weird edge cases and risks. All the teams are months behind schedule. Every time they roll out a change to the claims processing workflows, a horde of customers descend on them with angry pitchforks in hand.
...
Max has a slightly bemused smile. Alistair would guess that he's hearing a more clear articulation of the "Why" behind the work then he's used to. "That's all really good, Al," he says[fn:: Alistair kind of hates being called Al]. "Really good."

And then, heady with this moment of praise, Alistair makes his crucial mistake. Having laid out the strategic outcome, and connected it to the work of his team, and earned some good will by doing so...

...he decides to make a pitch for Max to change his behavior.

But he *doesn't* really understand Max's feelings.

He says, "Here's the thing. I know we're behind. And I'm worried we're getting more behind. I don't know if you realize it, but a lot of people are feeling bottlenecked, waiting for decisions." He takes a deep breath. "Specifically, waiting for decisions from you."
...
Max frowns. He looks away. He stares up a corner of the room. Then, he brings his gaze back to Alistair. "I would like nothing better, *Al*," he says, with icy sharpness, "but no one has stepped up. No one has shown *ownership*. You're asking for me to delegate? To who? What, exactly? Every time I take my eye of the ball, things have gotten screwed up."
...
Alistair stands up. "Okay. I. I see." With that, he steps awa.

"Thank you," says Max curtly, and leans down over his laptop again.
...
This is a very good start. But we need to dig deeper. We need to understand *why*, exactly, Max is strugglgin with fear and anxiety.
