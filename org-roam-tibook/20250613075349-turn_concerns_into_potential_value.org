...
** "The Database Is On the Verge of Death And No One Cares"
The whole company is super focused on the next big feature launch, but that one grizzled engineer on your team keeps on pounding their metaphorical fist on the table in various meetings, trying to convince everyone that main shared database is running out of capacity.

But... that engineer seems to always complain about the database? And no one really knows what would make things better short of a full rearchitecting to move to {NoSQL, Distributed Datastores, Microservices}.
