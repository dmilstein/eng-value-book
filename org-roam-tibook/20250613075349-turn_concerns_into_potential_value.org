...
** "The Database Is On the Verge of Death And No One Cares"
The whole company is super focused on the next big feature launch, but that one grizzled engineer on your team keeps pounding their fist on the table in various meetings, trying to convince everyone the database is about to fall over[fn:: I imagine them saying "Databasus delenda est" (that one's for all you classic geeks out there)].

But... that engineer seems to always complain about the database?

And no one really knows what would make things better short of some massive change.

Sure, there are a few recently-hired engineers who are trying to sell the team on a move to {NoSQL, Distributed Datastores, Microservices}, but you're justifiably nervous about anything that drastic.

And you don't really know how bad things are?

But also, that one team just added that feature that kinda sorta maybe does a crazy ton of new queries and just hammers the database all the time?
