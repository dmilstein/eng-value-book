...
If a team creates incremental value, then, well, they can *never really lose*. There's no panicked anxiety looming over them, because they can always stop, and the rest of the business will be Some Degree of Happy---because they will have gotten *some* value. The Rest of the Business may not get everything they *expected*, but if they get some genuine value, a smart PM and engineering lead can find a way to help the rest of the business understand the win. (There's a whole other series, about how to draw stakeholders into collaboration around these increments, but we'll start by understanding which increments are even valuable in the first place)
...
# Maybe, for each of these, explain when it's good, when not
