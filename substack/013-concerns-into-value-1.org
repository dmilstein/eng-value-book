...
To do so, we're going to develop a nuanced understanding of how incremental development can steadily create value for an overall business. We'll therefore come to understand how certain increments, despite intense engineering work, can *create no value* whatsoever.

Let's start by *seeing* why it's so important to design good increments.
...
The team does all the rituals, and does them faithfully and well. Their sprints are a crisp two weeks long. They start each sprint on a Monday morning with a full team planning session. They gather every day for standup, and then individual engineers pull well-groomed tickets from their board. On the final Friday of the sprint, the engineers demo what they've built, and then the team runs a brief retro in the afternoon.
...
The team is far, far behind where they are supposed to be. There don't seem to be any options whatsoever to catch up. Every lingering problem they finally tackle immediately sprouts three new problems, hydra-like. The PM is losing sleep, and wakes each morning from anxious dreams about their next update to the executive team. The engineers have grown defeatist and bitter. Every day they're asked to pile new expedient hacks on top of yesterday's expedient hacks, resulting in a system that is already profoundly unstable and getting steadily worse. But, because they've already missed all their key delivery dates, there's no time to deal with any of the emerging problems. The team just soldiers on, having long since given up on shipping something that they can be proud of. The engineers and the PM's both have a growing suspicion that when they finally *do* ship the unstable, limited, badly compromised product, literally everyone will be angry at them. This is, in fact, exactly what will happen.
...
How did this team get here? And how can we avoid getting here in the future? Why didn't "doing agile" save them? Note: I am a huge believer in agile as a way to organize the work of a team. This post is speaking about why agile tactics, as commonly practiced, are not enough. They are, in the terminology of my friends the mathematicians, *necessary but not sufficient*.

Let's rewind to the start of the project.

At the time, senior non-technical stakeholders grudgingly conceeded to the project being run "via Agile", because otherwise the engineers would have actually quit[fn:: More accurately, because the engineers and product team were so confidently dismissive of the way the stakeholders *wanted* to run the project. The tech team derisively called the stakeholder's desired approach "waterfall". The stakeholder didn't really understand what the alternative to "waterfall" was, but they've been around software development for long enough to know "waterfall" is Very Bad Indeed, so they didn't force the question]. But those stakeholders extracted a concession of their own from the product team: a commitment to complete the project by Q2 of the following year.
...
The engineers, led by one of the senior engineers, used a very common approach to develop their increments: they first broke the planned system down into a set of large components, then ordered the development of those components in a way that felt natural to them. The choice of order didn't feel super high stakes to them---no matter the order, they'd ultimately have to build it all. In this particular case, they decided to start with something fairly easy first, to create some momentum.

Once the engineers had the increments, they estimated each, the product team turned all of that into milestones in a schedule, and assigned deadlines for each. Together, the engineers and product team reviewed that schedule, and then product team cut a meaningful amount of scope, to ensure there was a comfortable four weeks of padding at the end of the project, in case anything went wrong.

And the engineers got to work, in their (well-observed!) agile process.

No one knew it, but this team was already doomed.
