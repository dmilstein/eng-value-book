* The Art of Increment Design, Part I - The Value Of Increments
** Titles
...
To understand why, we'll start by developing a nuanced understanding of how engineering work does (or does *not*) create value for an overall business (building on previous posts [link], [link]). We'll discover how some increments can, despite consuming a great deal of engineering effort, somehow create *no value whatsoever*. We'll also find how other increments, even one where the engineers write very little code, can somehow create a great deal of value.

This understanding of value will ultimately both give us tools to break large efforts into small pieces, but *also* offer creative ways to mix in increments of value-creating work to address a wide variety of concerns, e.g. being able to make smalll, safe, frequent deploys; ensuring a system can handle expected increases in load; meeting security expectations of customers; etc.

Why is good increment design so valuable?

As a theater teacher of mine once said, "The beauty of something is made clear by its absence."
...
Sometimes, in the middle of a dark wood, an engineer or a PM will find themselves on a team that is "doing Agile", but that doesn't *feel* agile in any way.
...
Why didn't "doing agile" save them? I am a huge believer in agile as a way to organize the work of a team. But, unfortunately, agile tactics, as commonly practiced, are not enough. They are, in the terminology of my friends the mathematicians, *necessary but not sufficient*.
...
That is to say, they decided what they would build first, what they would build second, etc. The product team wasn't closely involved in the development of the increments---they considered themselves a consumer of this "engineering" process[fn:: or, perhaps, the engineers pushed them out of the room].
...
They chose their overall increments arbitrarily and poorly.
