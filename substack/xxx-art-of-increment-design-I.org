...
Say an engineer joins a B2B SaaS company, and knows that they were hired because the company urgently wants to ship a new product within the year. However, on their first day, that engineer discovers to their horror that the company only ships to production *once per quarter*. In such a situation, just about every engineer I know would tell their leadership that improving frequency of deploy should be their absolute top priority.

That engineer would not make that case because frequent deploys "feel good" to them. They'd advocate for that work because they know in their bones that their new company has absolutely zero chance of shipping a valuable new product within a year if they can only deploy to production four times during that period.

If that engineer, through some combination of advocacy and technical work, managed to get deploys happening *once per week* (aka c. 10 times more often), they would feel like they had created a ton of value for their company.
...
First, by steadily building something that customers can *use*, you can get feedback from customers. The customer goes from sad to happy in increments, each of those is a chunk of evidence that you're moving in the right direction.
...
The product team is the people of whom demands are made! They have the awesome power of saying no to people (aka prioritization), and with it the attendant awesome power of everyone being mad at them, all the time!
