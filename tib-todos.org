...
** TODO Add: fear of loss of control for stakeholder :curweek:pom:
...
** DONE Rewrite opening to get to the fucking point :curweek:pom:
CLOSED: [2025-06-25 Wed 11:23]
** DONE Add decision increments for scenarios     :curweek:
CLOSED: [2025-06-27 Fri 07:00]
** DONE Weave through: decision, options, offramps :curweek:pom:
CLOSED: [2025-06-27 Fri 08:04]
** TODO Break out Design Milestones chapter?      :curweek:
** TODO Review/clean up Understand Stakeholder    :curweek:pom:
...
** TODO Add Off Ramp to my first full example     :curweek:pom:
** TODO Add Off Ramps to the Decision-Framing examples :curweek:pom:
** TODO Find Satoe's thing about cave in her HTB thing :curweek:
** TODO Review Ell Milestones doc for ideas       :curweek:
...
** TODO Brainstorm 10 bad ideas for "hearing from" people as part of Author Platform
** TODO Define rewards/celebrations for hitting Author Platform incremental goals
E.g. buy myself dinner, or a game, or go out w/ friends, or tell Edmund + someone, take Bonnie out for dinner.
** TODO Research: blueskey or other places for building followers
** TODO Spike: Medium cross-post 1/month, Substack 1/week
** DONE Define next increment of success, create viz :curweek:pom:
...
** TODO HTB: Get footnotes to number by chapter
** TODO HTB: Add --toc to the pandoc, can I get a ToC in helpthisbook?
** TODO HTB: For that toc, set --toc-depth=2, I think
** TODO Load into HTB
...
** TODO Write my "do you want to be a beta reader" invite
Steal from WUB

** TODO Decide where / how to post that

** TODO Decide who / how to ask about that
E.g. TechDinner
** TODO Write "guide for beta readers", load into HTB
Steal from WUB
...
** DONE Make plan + tasks for Beta Reading        :curweek:pom:
...
** TODO Fix word count to handle 0 days
