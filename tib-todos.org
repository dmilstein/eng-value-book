...
** TODO Clean up the SELECT_TAGS/OPTIONS/:export stuff if I don't need it
** TODO Ask Edmund: reframe as "How To Work With Stakeholders"?
Like, that's sort of what it's becoming? Is *that* the urgent pain?
** TODO Ask Dani: what was that podcast? How does she get ideas?
** TODO Decide: really show everyone's comments? I hate it, start without it
** TODO Spike is the (Personal) thing fucking up org-roam?
I should just nuke the non-personal one to clean this up
...
** TODO Add a prompt to sign in
** DONE Figure out footnotes/toc for HTB          :curweek:pom:
CLOSED: [2025-07-01 Tue 18:32]
** DONE pandoc: pre-process, extract chapter text :curweek:pom:
CLOSED: [2025-07-01 Tue 18:32]
...
** DONE Review WUB, add todos                     :curweek:
CLOSED: [2025-07-01 Tue 09:48]
** DONE Draft TD Invite                           :curweek:
...
** TODO Spike on zipfile upload (fix footnotes)
Markdown Project.zip
├─ chapter 1.md
├─ chapter 2.md
** DONE HTB: try to import ToC                    :curweek:
CLOSED: [2025-07-01 Tue 18:37]
Add --toc to the pandoc?
Set --toc-depth=2?
** DONE Decide how many chapters                  :curweek:pom:
CLOSED: [2025-07-01 Tue 09:12]
** TODO Footnotes are totally borked              :curweek:
** TODO Send a round of invites out               :curweek:
To... someone
** DONE Load into HTB                             :curweek:
CLOSED: [2025-07-01 Tue 18:59]
** DONE Draft "guide for beta readers"            :curweek:
CLOSED: [2025-07-01 Tue 09:48]
Steal from WUB

** DONE Dry Run / test with EWJ                   :curweek:
CLOSED: [2025-07-01 Tue 18:59]
** DONE Make list of places to send invite        :curweek:
CLOSED: [2025-07-01 Tue 10:12]
** DONE Draft beta reading invite                 :curweek:pom:
...
** TODO Write "bad/dry" summary of scenario       :pom:
** TODO Show how to apply storytelling techniques :pom:
