...
** TODO Post "Offer Future Decision" to Substack
** TODO Post "Propose a Timebox" to Medium
...
** DONE Carve out first chapter for Beta          :curweek:
...
** DONE Make [[file:org-roam-tibook/20251027103957-unstuck_beta.org::*Hit List of Todos][hit list]] of remaining changes :curweek:
CLOSED: [2025-12-17 Wed 08:40]
:LOGBOOK:
CLOCK: [2025-12-17 Wed 08:31]--[2025-12-17 Wed 08:40] =>  0:09
:END:
** TODO Deal with multiple Alistair/Max scenes    :curweek:pom:
:LOGBOOK:
CLOCK: [2025-12-17 Wed 08:40]
:END:
As in, I have multiple, conflicting version of Alistair building rapport
** TODO Pick version of Catalog of Tactics
** TODO Look at book blockers ideas from HTB
In email

** TODO Review tooling for HTB
** TODO Produce/upload to HTB
** TODO Draft invitation
** TODO Make list of people to send invitation
** TODO Make explicit "track progress" game plan
...
** TODO For multiple Alistair break throughs: can I use suspense?
As in, leave it for later chapters to see how it plays out?
** TODO Ugh: Fix two conflicting scenes of Alistair breaking through.
