...
** DONE Finish working in mini-examples           :curweek:
...
** DONE Format for Substack                       :curweek:
...
:END:
** TODO Keep reviewing from [[file:org-roam-tibook/20250812093351-intro_work_with_humans.org::*1. Identify a long-term, strategic outcome that your stakeholder cares intensely about][checkpoint]]            :curweek:pom:
:LOGBOOK:
CLOCK: [2025-11-02 Sun 07:37]
:END:
...
** TODO Review in light of new intro              :curweek:pom:
:LOGBOOK:
