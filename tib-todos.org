...
** TODO Thank you to Margaret (ask collab w/ product) :curweek:pom:
** TODO Ask Margaret: apply any ideas
** TODO Make list of another 10 people
** TODO Send 10 more invites
** TODO Draft nudge to first round (re collab w/ product) :curweek:pom:
...
** TODO Review Incidents as Warning Signs         :curweek:
** TODO Revise Post-Mortems/Stakeholders          :curweek:
** TODO First draft: Create Incidents             :curweek:
...
** TODO Make github repo for TIB, push it up      :curweek:pom:
