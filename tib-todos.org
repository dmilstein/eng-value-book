...
** TODO Write forward from solving biz problems   :curweek:pom:
:LOGBOOK:
CLOCK: [2025-08-12 Tue 09:31]
:END:
** TODO Say "you need both"                       :curweek:pom:
...
** TODO Experiment: shrink game plan              :curweek:
** TODO Speak to cyclic nature of trust building  :curweek:
** TODO Save the full game plan? Get to useful things faster?
...
** TODO Spend more time in intro on "learn better patterns"
...
** DONE Write 2 more problems                     :curweek:pom:
...
** DONE Break out 4-6 "problems"                  :pom:
CLOSED: [2025-08-06 Wed 17:03]
** DONE Write 1 problem                           :pom:
CLOSED: [2025-08-07 Thu 08:58]
* [[id:A1EF14A2-5F19-488D-926C-A8208142E794][Strat Intent]]                                    :gtasks:
** TODO Review Tech Invest chapters               :curweek:
** TODO Write bad first draft                     :curweek:
** TODO Add explicit "Be in detective mode"       :curweek:
...
** TODO Ping Lisa P, ask what she's applied       :curweek:
DEADLINE: <2025-08-14 Thu>
** TODO Ping Jacob, ask how it's going
...
** TODO Write email to EWJ re posting to Medium
...
** DONE Timeboxed spike on pom->clock->DONE       :curweek:
CLOSED: [2025-08-11 Mon 16:39]
** TODO Write out 3 bad ways to clock time
...
** TODO Try one of those bad ways to clock time
