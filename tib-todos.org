...
** TODO Jam out a terrible intro. Like, terrible  :pom:
...
** TODO Write python script to convert toc.org to file list
Ask aidermacs to factor it out of existing code
** TODO Makefile: regen chapter file list when toc changes
** TODO Write script to build full Markdown of book
By feeding chapter files in order to my org-to-md.sh script, concatenating output
** TODO Add Makefile target for full Markdown
...
** TODO Satoe - milestones, not tech investment.  :curweek:
