...
** TODO Break out 3 (or 4) distinct challenges    :curweek:pom:
** TODO Move solution to challenges out of intro  :curweek:pom:
** TODO Write Analytics 2.0 as increments/decisions :curweek:
...
** TODO Stash my existing ToC somewhere           :curweek:
