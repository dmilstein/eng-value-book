...
** TODO Turn structure into draft ToC             :curweek:
** TODO Revise ToC                                :curweek:
** TODO Spike on new intro                        :curweek:pom:
** TODO Revise new intro                          :curweek:
...
** TODO Draft new email re coaching/helping       :curweek:
Review the email I wrote EWJ
** TODO Make list of people to reach out to       :curweek:
** TODO Reach out to people                       :curweek:
...
** TODO Simple, dumb idea for organizing posts    :curweek:
...
** TODO Review Data Intensive Systems write up on book economics
