...
:END:
** DONE Move solution to challenges out of intro  :curweek:pom:
CLOSED: [2025-07-22 Tue 08:11]
** TODO Fundamental Challenge as separate chapter? :curweek:
** TODO Break out 3/4 distinct challenges         :curweek:
** TODO Write the "if only" section               :curweek:
** TODO Write Analytics 2.0 as increments         :curweek:
** TODO Write Maint Triage as interruption        :curweek:
** TODO Write Konicki/metrics as empathy          :curweek:
** TODO Paste in Flagship Deploys as tech invest  :curweek:
** TODO Experiment w/ EWJ's summary?
Half of what they asked for we never finished, half of what remained was never used.
** TODO Signal, early on, that I'm not demonizing PMs's
...
** TODO Type up (Wispr?) new ToC + Intro structure from notebook :curweek:
** DONE Stash my existing ToC somewhere           :curweek:
...
** TODO Learn just enough to clock in and out for writing hours (ask Claude?) :curweek:
** DONE Make watch_book.sh work for new book      :curweek:
CLOSED: [2025-07-21 Mon 08:38]
