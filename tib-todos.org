...
** TODO Commit to toc.org instead of current thing (add to Roam)
** TODO Within "I Can't Think" tease out two forms of viz
...
** DONE Spike on bad intro                        :curweek:pom:
CLOSED: [2025-06-13 Fri 11:05]
** DONE Write about terrible code                 :curweek:
CLOSED: [2025-06-13 Fri 11:06]
** DONE Write about deploys                       :curweek:
CLOSED: [2025-06-14 Sat 10:23]
** DONE Write "I can't find a moment to think"    :curweek:pom:
CLOSED: [2025-06-14 Sat 17:41]
** TODO Write "The DB is on the verge of death"   :curweek:
...
** DONE Post to LinkedIn once Substack is live    :curweek:
...
** DONE Draft 1-2 next posts, prep                :curweek:
...
CLOSED: [2025-06-12 Thu 09:42]
** DONE First draft Reduce Interruptive Maintenance Work :curweek:
...
** TODO Review WUB re: beta readers + partial book
...
** DONE Within tib-todos, add todo at top of list :curweek:
...
** DONE Make the word count tool handle initial chapter text :curweek:pom:
...
** TODO For teminal UI word counts, add basic horizontal bars
...
** DONE Update gnuplot script to determine date range from file? :curweek:pom:
